...
_08047C4C:
	...
	cmp r7, #0
	bne _08047C68
	ldr r0, _08047C64 @ =gStageData
	ldrb r1, [r0, #6]
	b _08047C72
	.align 2, 0
_08047C5C: .4byte gCurTask
_08047C60: .4byte 0x03000080
_08047C64: .4byte gStageData
_08047C68:
	adds r0, r4, #0
	adds r0, #0x2b
	ldrb r1, [r0]
...
_08047C72:
	...
	beq _08047D2C
	ldr r1, [r4]
	ldr r0, _08047CE4 @ =Player_8008A8C
	cmp r1, r0
	beq _08047D2C
	ldr r0, _08047CE8 @ =Player_800ED80
	cmp r1, r0
	beq _08047D2C
	mov r0, sl
	lsls r1, r0, #0x10
...
_08047CE4: .4byte Player_8008A8C
_08047CE8: .4byte Player_800ED80
_08047CEC:
	adds r1, r5, #0
	adds r1, #0x84
...
_08047E64:
	...
	adds r2, r1, #0
	ldr r1, [r2]
	ldr r0, _08047E8C @ =Player_8008A8C
	cmp r1, r0
	beq _08047E80
	ldr r0, _08047E90 @ =Player_800ED80
	cmp r1, r0
	bne _08047E98
_08047E80:
...
_08047E90: .4byte Player_800ED80
