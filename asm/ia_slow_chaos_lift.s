...
.endif
	...
	thumb_func_start Task_803DED0
Task_803DED0: @ 0x0803DED0
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_0803DF98: .4byte gSineTable
_0803DF9C: .4byte 0x03000068
_0803DFA0: .4byte 0x0300006A
_0803DFA4: .4byte Task_803E0D8
_0803DFA8:
...
_0803DFC8:
	...
	cmp r4, #0
	bne _0803DFE0
	ldr r0, _0803DFDC @ =gStageData
	ldrb r1, [r0, #6]
	b _0803DFEA
	.align 2, 0
_0803DFD8: .4byte 0x03000066
_0803DFDC: .4byte gStageData
_0803DFE0:
	adds r0, r6, #0
	adds r0, #0x2b
	ldrb r1, [r0]
