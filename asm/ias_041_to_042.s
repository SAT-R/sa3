...
sub_8031758: @ 0x08031758
	...
	lsls r0, r0, #0x18
	lsrs r1, r0, #0x18
	ldr r0, _0803179C @ =gUnknown_03003B60
	ldr r0, [r0]
	ldrh r0, [r0, #6]
...
_0803178C:
	...
	b _080317AC
	.align 2, 0
_0803179C: .4byte gUnknown_03003B60
...
sub_803185C: @ 0x0803185C
	...
	sub sp, #8
	movs r5, #0
	ldr r0, _080318B0 @ =gUnknown_03003B60
	ldr r0, [r0]
	ldrh r1, [r0, #6]
	movs r0, #0xc0
	lsls r0, r0, #0x12
...
_0803189C:
	...
	b _080318B8
	.align 2, 0
_080318B0: .4byte gUnknown_03003B60
_080318B4:
...
sub_8031974: @ 0x08031974
	...
	mov r7, r8
	push {r7}
	ldr r0, _080319C8 @ =gUnknown_03003B60
	mov r8, r0
	ldr r0, [r0]
	ldrh r1, [r0, #6]
	movs r0, #0xc0
	...
	b _08031A0A
	.align 2, 0
_080319C8: .4byte gUnknown_03003B60
