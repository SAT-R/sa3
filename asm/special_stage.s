...
sub_80B1AF4: @ 0x080B1AF4
	...
	str r1, [r0]
	bl sub_80B6B20
	ldr r0, _080B1B98 @ =Task_80B2228
	ldr r1, _080B1B9C @ =0x000008E8
	movs r2, #0x80
	lsls r2, r2, #6
	ldr r3, _080B1BA0 @ =TaskDestructor_80B2224
	str r3, [sp]
	movs r3, #0
	bl TaskCreate
	ldrh r2, [r0, #6]
	...
	lsls r0, r0, #0x12
	adds r7, r2, r0
	ldr r1, _080B1BA4 @ =0x030008B0
	adds r0, r2, r1
	movs r1, #0x80
	lsls r1, r1, #0x11
	str r1, [r0]
	ldr r3, _080B1BA8 @ =0x030008B4
	adds r0, r2, r3
	str r1, [r0]
	ldr r1, _080B1BAC @ =0x030008B8
	adds r0, r2, r1
	str r4, [r0]
	adds r3, #8
	adds r1, r2, r3
...
_080B1B98: .4byte Task_80B2228
_080B1B9C: .4byte 0x000008E8
_080B1BA0: .4byte TaskDestructor_80B2224
_080B1BA4: .4byte 0x030008B0
_080B1BA8: .4byte 0x030008B4
_080B1BAC: .4byte 0x030008B8
_080B1BB0: .4byte 0x030008C6
_080B1BB4:
	ldr r3, _080B1CEC @ =0x030008C6
	adds r1, r2, r3
	movs r0, #2
	strb r0, [r1]
_080B1BBC:
...
_080B1E1C: .4byte 0x030008C7
_080B1E20: .4byte 0x03000014
_080B1E24: .4byte gBldRegs
_080B1E28: .4byte 0x030008BE
...
sub_80B1E34: @ 0x080B1E34
	...
	lsls r0, r0, #0x12
	adds r4, r5, r0
	ldr r0, _080B1E60 @ =0x030008C4
	adds r1, r5, r0
	movs r0, #2
	strh r0, [r1]
	ldr r3, _080B1E64 @ =0x030008BE
	adds r0, r5, r3
	movs r3, #0
	ldrsh r0, [r0, r3]
	cmp r0, #0
...
_080B1E60: .4byte 0x030008C4
_080B1E64: .4byte 0x030008BE
_080B1E68:
	adds r0, r4, #0
	bl sub_80B33D0
	str r0, [r4, #8]
	ldr r0, _080B1E9C @ =0x030008E4
	adds r1, r5, r0
...
sub_80B1EC8: @ 0x080B1EC8
	...
	ldr r0, [r3]
	ldrh r2, [r0, #6]
	ldr r1, _080B1F30 @ =0x030008C8
	adds r0, r2, r1
	ldrb r0, [r0]
	cmp r0, #0
	bne _080B1EE4
	ldr r4, _080B1F34 @ =0x030008BE
	adds r1, r2, r4
	ldrh r0, [r1]
	adds r0, #1
	strh r0, [r1]
_080B1EE4:
	ldr r0, _080B1F38 @ =0x030008DF
	adds r1, r2, r0
	movs r0, #0x3c
	strb r0, [r1]
	ldr r4, _080B1F3C @ =0x030008DA
	adds r1, r2, r4
	movs r0, #0x8c
	strh r0, [r1]
	ldr r0, _080B1F40 @ =0x030008B0
	adds r1, r2, r0
	movs r0, #0x80
	lsls r0, r0, #0x12
	str r0, [r1]
...
_080B1F30: .4byte 0x030008C8
_080B1F34: .4byte 0x030008BE
_080B1F38: .4byte 0x030008DF
_080B1F3C: .4byte 0x030008DA
_080B1F40: .4byte 0x030008B0
_080B1F44: .4byte 0x030008C4
...
_080B214E:
	...
	bne _080B218C
	movs r4, #0
	ldr r3, _080B2180 @ =0x030008C2
	adds r0, r5, r3
	ldr r6, _080B2184 @ =0x030008C0
	adds r1, r5, r6
	movs r3, #0
	ldrsh r2, [r0, r3]
	movs r6, #0
...
_080B2180: .4byte 0x030008C2
_080B2184: .4byte 0x030008C0
_080B2188: .4byte 0x030008C7
_080B218C:
	ldr r1, _080B21D4 @ =0x030008D4
	adds r0, r5, r1
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	ldr r2, _080B21D8 @ =0x030008C7
	adds r3, r5, r2
	cmp r0, #0
	beq _080B21A6
	adds r4, r3, #0
...
_080B21A6:
	movs r4, #0
	ldr r6, _080B21DC @ =0x030008C2
	adds r0, r5, r6
	ldr r2, _080B21E0 @ =0x030008C0
	adds r1, r5, r2
	movs r6, #0
	ldrsh r2, [r0, r6]
	movs r6, #0
...
_080B21BE:
	ldrb r1, [r3]
_080B21C0:
	ldr r2, _080B21E4 @ =0x030008C6
	adds r0, r5, r2
	ldrb r2, [r0]
	ldr r3, _080B21E8 @ =0x030008C9
	adds r0, r5, r3
	ldrb r3, [r0]
	adds r0, r4, #0
	bl sub_80B6CD8
	b _080B220C
	.align 2, 0
_080B21D4: .4byte 0x030008D4
_080B21D8: .4byte 0x030008C7
_080B21DC: .4byte 0x030008C2
_080B21E0: .4byte 0x030008C0
_080B21E4: .4byte 0x030008C6
_080B21E8: .4byte 0x030008C9
_080B21EC:
	ldr r0, _080B221C @ =0x030008C9
	adds r2, r5, r0
	movs r3, #1
	adds r0, r3, #0
	ldrb r1, [r4]
...
_080B2214:
	...
	bx r0
	.align 2, 0
_080B221C: .4byte 0x030008C9
_080B2220: .4byte gCurTask
    
	thumb_func_start TaskDestructor_80B2224
TaskDestructor_80B2224: @ 0x080B2224
	bx lr
	.align 2, 0

	thumb_func_start Task_80B2228
Task_80B2228: @ 0x080B2228
	push {r4, r5, lr}
	sub sp, #0x18
	...
	movs r2, #0x28
	bl sub_80B6BB8
	ldr r0, _080B227C @ =0x030008C4
	adds r4, r4, r0
	movs r0, #1
	strh r0, [r4]
	movs r0, #0x41      @ MUS_SPECIAL_STAGE
	bl m4aSongNumStart
	ldr r1, [r5]
...
sub_80B2284: @ 0x080B2284
	...
	cmp r0, #0
	beq _080B22B0
	ldr r0, _080B22C0 @ =0x030008BE
	adds r1, r4, r0
	movs r0, #0
	strh r0, [r1]
	ldr r0, _080B22C4 @ =0x030008C4
	adds r1, r4, r0
	movs r0, #4
	strh r0, [r1]
	ldr r1, [r5]
...
_080B22C0: .4byte 0x030008BE
_080B22C4: .4byte 0x030008C4
...
sub_80B292C: @ 0x080B292C
	...
	ldr r2, _080B29A4 @ =gObjPalette + 0x1F2
	str r2, [r0]
	movs r3, #0xa6
	lsls r3, r3, #2
	adds r1, r5, r3
...
_080B29A4: .4byte gObjPalette + 0x1F2
...
_080B3644: .4byte 0x00000326
	...
	thumb_func_start Task_80B3648
Task_80B3648: @ 0x080B3648
	push {r4, r5, r6, lr}
...
sub_80B3D4C: @ 0x080B3D4C
	...
	movs r0, #0xff
	strb r0, [r1]
	movs r0, #0x5c      @ MUS_SPECIAL_STAGE_CLEAR
	bl m4aSongNumStart
	b _080B3DF2
	.align 2, 0
...
_080B6D6E:
	...
	thumb_func_start Task_80B6D78
Task_80B6D78: @ 0x080B6D78
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_080B6E94:
	...
	movs r2, #0x20
	bl sub_80B6BB8
	movs r0, #0x43      @ MUS_SPECIAL_STAGE_RESULT_2
	bl m4aSongNumStart
	b _080B7012
	.align 2, 0
...
_080B6F1C:
	...
	beq _080B6FC8
_080B6FA2:
	movs r0, #0x42      @ MUS_SPECIAL_STAGE_RESULT_1
	bl m4aSongNumStart
	b _080B7012
	.align 2, 0
...
_080B7304:
	...
	thumb_func_start Task_80B7314
Task_80B7314: @ 0x080B7314
	push {r4, lr}
...
_080B742E:
	...
	mov r0, r8
	ldr r1, [r0]
	ldr r0, _080B7444 @ =Task_80B75A0
	str r0, [r1, #8]
	b _080B7462
	.align 2, 0
_080B7440: .4byte gPressedKeys
_080B7444: .4byte Task_80B75A0
_080B7448:
	movs r0, #0x30
	ands r0, r1
	cmp r0, #0
