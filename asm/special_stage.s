...
.endif
	...
	thumb_func_start Task_8E8_80B1E34
Task_8E8_80B1E34: @ 0x080B1E34
	push {r4, r5, lr}
...
TaskDestructor_80B2224: @ 0x080B2224
	...
	thumb_func_start Task_8E8_80B2228
Task_8E8_80B2228: @ 0x080B2228
	push {r4, r5, lr}
	sub sp, #0x18
	...
	bl m4aSongNumStart
	ldr r1, [r5]
	ldr r0, _080B2280 @ =Task_8E8_80B1DA0
	str r0, [r1, #8]
	add sp, #0x18
	pop {r4, r5}
	pop {r0}
...
_080B2280: .4byte Task_8E8_80B1DA0
