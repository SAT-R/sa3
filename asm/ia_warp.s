...
sub_802E528: @ 0x0802E528
	...
	mov r5, r8
	push {r5, r6, r7}
	ldr r4, _0802E59C @ =gUnknown_030008A0
	ldrb r0, [r4, #6]
	cmp r0, #0
	bne _0802E61C
	...
	adds r0, r0, r1
	lsls r0, r0, #4
	ldr r1, _0802E5A4 @ =gUnknown_030015C0
	adds r5, r0, r1
	mov r0, sb
	lsls r1, r0, #3
	lsls r2, r2, #8
...
sub_802E634: @ 0x0802E634
	...
	ldrh r3, [r0, #4]
	ldrh r4, [r0, #6]
	ldr r0, _0802E68C @ =gUnknown_030008A0
	ldrb r1, [r0, #6]
	lsls r0, r1, #2
	adds r0, r0, r1
	lsls r0, r0, #2
	adds r0, r0, r1
	lsls r0, r0, #4
	ldr r1, _0802E690 @ =gUnknown_030015C0
	adds r1, r0, r1
	lsls r2, r2, #3
	lsls r3, r3, #8
	adds r2, r2, r3
...
sub_802E6F8: @ 0x0802E6F8
	...
	cmp r4, #2
	bne _0802E714
	ldr r0, _0802E748 @ =gUnknown_030008A0
	ldrb r0, [r0, #3]
	cmp r0, #0
	bne _0802E736
_0802E714:
...
_0802E764:
	...
	b _0802E7E6
_0802E76E:
	ldr r4, _0802E7A0 @ =gUnknown_030008A0
	ldrb r0, [r4, #3]
	cmp r0, #4
	bls _0802E788
	ldrb r1, [r4, #9]
...
_0802E788:
	...
	b _0802E7E6
	.align 2, 0
_0802E7A0: .4byte gUnknown_030008A0
_0802E7A4:
	bl sub_802E87C
	b _0802E7E6
_0802E7AA:
...
_0802E828:
	cmp r5, #1
	bne _0802E834
	ldr r0, _0802E874 @ =gUnknown_030008A0
	ldrb r0, [r0, #3]
	cmp r0, #0
	bne _0802E85E
_0802E834:
	ldr r0, _0802E878 @ =sub_802E528
	movs r2, #0x80
	lsls r2, r2, #6
	movs r4, #0
	str r4, [sp]
...
_0802E85E:
	...
	bx r0
	.align 2, 0
_0802E874: .4byte gUnknown_030008A0
_0802E878: .4byte sub_802E528

	thumb_func_start sub_802E87C
sub_802E87C: @ 0x0802E87C
	push {lr}
	ldr r0, _0802E88C @ =gUnknown_030008A0
	ldrb r0, [r0, #3]
	cmp r0, #0
	beq _0802E890
	cmp r0, #5
	...
	b _0802E8A2
	.align 2, 0
_0802E88C: .4byte gUnknown_030008A0
_0802E890:
	movs r0, #0xb
	movs r1, #0
	bl sub_8002210
...
sub_802E8A8: @ 0x0802E8A8
	push {lr}
	ldr r0, _0802E8B8 @ =gUnknown_030008A0
	ldrb r0, [r0, #3]
	cmp r0, #0
	beq _0802E8BC
	cmp r0, #5
	...
	b _0802E8D0
	.align 2, 0
_0802E8B8: .4byte gUnknown_030008A0
_0802E8BC:
	movs r0, #4
	bl sub_8097C54
	b _0802E8D0
...
Task_802E8D8: @ 0x0802E8D8
	...
	lsls r0, r0, #0x12
	adds r3, r3, r0
	ldr r0, _0802E920 @ =gUnknown_030008A0
	ldrb r1, [r0, #6]
	lsls r0, r1, #2
	adds r0, r0, r1
	lsls r0, r0, #2
	adds r0, r0, r1
	lsls r0, r0, #4
	ldr r1, _0802E924 @ =gUnknown_030015C0
	adds r0, r0, r1
	adds r0, #0x2c
	ldrb r1, [r0]
	movs r2, #0x40
