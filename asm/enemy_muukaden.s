...
_08062DC8:
	...
	ldrh r0, [r0]
	strh r0, [r4, #0xc]
	ldr r1, _08062DF8 @ =gUnknown_080D20C4+0x42
	ldrb r0, [r1]
_08062DD4:
	strb r0, [r4, #0x1a]
	movs r0, #0xff
	...
	b _08062E12
	.align 2, 0
_08062DF8: .4byte gUnknown_080D20C4+0x42
...
_08062E34:
	...
	ldrb r0, [r4, #0x1a]
	adds r1, r0, #0
	ldr r0, _08062E68 @ =gUnknown_080D20C4+0x42
	ldrb r0, [r0]
	cmp r1, r0
	bne _08062E82
_08062E4A:
	...
	b _08062E76
	.align 2, 0
_08062E68: .4byte gUnknown_080D20C4+0x42
_08062E6C:
	mov r1, r8
	ldrh r0, [r1, #0x30]
	strh r0, [r4, #0xc]
