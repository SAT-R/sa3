...
.arm
	...
	thumb_func_start Options_PlayerData
Options_PlayerData: @ 0x0808EF9C
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
	...
	adds r4, r2, #0
	adds r5, r3, #0
	ldr r0, _0808F058 @ =Task_Options_PlayerData
	movs r1, #0xb2
	lsls r1, r1, #1
	movs r2, #0x80
	lsls r2, r2, #1
	ldr r3, _0808F05C @ =TaskDestructor_Options_PlayerData
	str r3, [sp]
	movs r3, #0
	bl TaskCreate
	ldrh r1, [r0, #6]
...
_0808EFDE:
	...
	bx r0
	.align 2, 0
_0808F058: .4byte Task_Options_PlayerData
_0808F05C: .4byte TaskDestructor_Options_PlayerData
