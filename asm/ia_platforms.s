...
.endif
    ...
    thumb_func_start Task_Platform
Task_Platform: @ 0x0802ED40
    push {r4, r5, r6, r7, lr}
    mov r7, sl
    mov r6, sb
    mov r5, r8
...
_0802ED9C:
    ...
    adds r1, r1, r0
    lsls r1, r1, #4
    ldr r0, _0802EDC4 @ =gPlayers
    adds r4, r1, r0
    b _0802EDE0
    .align 2, 0
_0802EDB8: .4byte gCurTask
_0802EDBC: .4byte 0x0300002C
_0802EDC0: .4byte gStageData
_0802EDC4: .4byte gPlayers
_0802EDC8:
    adds r0, r4, #0
    adds r0, #0x2b
    ldrb r1, [r0]
...
_0802F25E:
    ...
    b _0802F27C
    .align 2, 0
_0802F274: .4byte gPlayers
_0802F278:
    ldr r0, _0802F2B0 @ =gStageData
    ldrb r1, [r0, #6]
_0802F27C:
    lsls r0, r1, #2
    adds r0, r0, r1
...
sub_802F2C8: @ 0x0802F2C8
    ...
    beq _0802F354
    movs r1, #0
    ldr r3, _0802F304 @ =gPlayers
_0802F2EC:
    lsls r0, r1, #0x10
    adds r2, r0, #0
    cmp r2, #0
    bne _0802F30C
    ldr r0, _0802F308 @ =gStageData
    ldrb r1, [r0, #6]
    b _0802F316
    .align 2, 0
_0802F2FC: .4byte gCurTask
_0802F300: .4byte 0x0300002C
_0802F304: .4byte gPlayers
_0802F308: .4byte gStageData
_0802F30C:
    adds r0, r4, #0
    adds r0, #0x2b
    ldrb r1, [r0]
