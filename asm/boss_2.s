...
.arm
	...
	thumb_func_start CreateEggWheeler
CreateEggWheeler: @ 0x0806A90C
	push {r4, r5, r6, r7, lr}
	mov r7, r8
	push {r7}
	sub sp, #8
	...
	adds r4, r1, #0
	adds r5, r2, #0
	ldr r0, _0806A988 @ =Task_Boss2Init
	movs r1, #0x92
	lsls r1, r1, #1     @ 0x124
	movs r2, #0x84
	lsls r2, r2, #6
	ldr r3, _0806A98C @ =TaskDestructor_Boss2
	str r3, [sp]
	movs r3, #0
	bl TaskCreate
	mov r8, r0
	...
	b _0806A9A2
	.align 2, 0
_0806A988: .4byte Task_Boss2Init
_0806A98C: .4byte TaskDestructor_Boss2
