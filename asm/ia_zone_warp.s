...
CreateEntity_ZoneWarp: @ 0x0802D718
	...
	movs r0, #1
	ands r1, r0
	ldr r3, _0802D7E4 @ =gUnknown_030008A0
	ldr r6, _0802D7E8 @ =gUnknown_03000530
	cmp r1, #0
	bne _0802D760
	movs r2, #1
_0802D746:
...
_0802D7D4:
	...
	bx r0
	.align 2, 0
_0802D7E4: .4byte gUnknown_030008A0
_0802D7E8: .4byte gUnknown_03000530
...
sub_802D7FC: @ 0x0802D7FC
	...
	push {r6, r7}
	sub sp, #8
	ldr r0, _0802D8B0 @ =gUnknown_03003B60
	mov sb, r0
	ldr r0, [r0]
	ldrh r0, [r0, #6]
	movs r2, #0xc0
	...
	mov r8, r1
	ldr r3, [r2]
	ldr r5, _0802D8B8 @ =gUnknown_030008A0
	ldrb r1, [r5, #6]
	lsls r0, r1, #2
	adds r0, r0, r1
	lsls r0, r0, #2
	adds r0, r0, r1
	lsls r0, r0, #4
	ldr r1, _0802D8BC @ =gUnknown_030015C0
	adds r4, r0, r1
	ldrb r0, [r2, #0xa]
	lsls r0, r0, #3
	ldrh r1, [r2, #4]
...
_0802D89E:
	...
	bx r0
	.align 2, 0
_0802D8B0: .4byte gUnknown_03003B60
_0802D8B4: .4byte 0x0300000C
_0802D8B8: .4byte gUnknown_030008A0
_0802D8BC: .4byte gUnknown_030015C0
...
sub_802D8C8: @ 0x0802D8C8
	push {r4, r5, r6, lr}
	ldr r0, _0802D91C @ =gUnknown_030008A0
	ldrb r1, [r0, #6]
	lsls r0, r1, #2
	adds r0, r0, r1
	lsls r0, r0, #2
	adds r0, r0, r1
	lsls r0, r0, #4
	ldr r1, _0802D920 @ =gUnknown_030015C0
	adds r4, r0, r1
	ldr r3, _0802D924 @ =gUnknown_03003B60
	ldr r0, [r3]
	ldrh r1, [r0, #6]
	movs r0, #0xc0
	lsls r0, r0, #0x12
	...
	b _0802D938
	.align 2, 0
_0802D91C: .4byte gUnknown_030008A0
_0802D920: .4byte gUnknown_030015C0
_0802D924: .4byte gUnknown_03003B60
...
_0802D978:
	...
	cmp r0, #0
	beq _0802D994
	ldr r0, _0802D9A0 @ =gUnknown_03003B60
	ldr r1, [r0]
...
sub_802D9A8: @ 0x0802D9A8
	...
	adds r0, r0, r1
	lsls r0, r0, #4
	ldr r1, _0802DA08 @ =gUnknown_030015C0
	adds r4, r0, r1
	ldr r6, _0802DA0C @ =gUnknown_03003B60
	ldr r0, [r6]
	ldrh r1, [r0, #6]
	movs r0, #0xc0
	lsls r0, r0, #0x12
...
_0802D9F4:
	...
	b _0802DA2C
	.align 2, 0
_0802DA04: .4byte gUnknown_030008A0
_0802DA08: .4byte gUnknown_030015C0
_0802DA0C: .4byte gUnknown_03003B60
...
sub_802DA3C: @ 0x0802DA3C
	push {r4, r5, lr}
	ldr r0, _0802DAB8 @ =gUnknown_03003B60
	ldr r0, [r0]
	ldrh r2, [r0, #6]
	ldr r4, _0802DABC @ =gUnknown_030008A0
...
_0802DA86:
	...
	ldr r0, _0802DAD8 @ =gUnknown_03003F34
	ldrb r0, [r0]
	strb r0, [r1]
	ldrb r0, [r4, #9]
	movs r1, #0
	...
	bx r0
	.align 2, 0
_0802DAB8: .4byte gUnknown_03003B60
_0802DABC: .4byte gUnknown_030008A0
...
_0802DAD8: .4byte gUnknown_03003F34
...
sub_802DADC: @ 0x0802DADC
	...
	push {r6, r7}
	sub sp, #8
	ldr r0, _0802DB84 @ =gUnknown_030008A0
	ldrb r1, [r0, #6]
	lsls r0, r1, #2
	adds r0, r0, r1
	lsls r0, r0, #2
	adds r0, r0, r1
	lsls r0, r0, #4
	ldr r1, _0802DB88 @ =gUnknown_030015C0
	adds r5, r0, r1
	ldr r0, _0802DB8C @ =gUnknown_03003B60
	mov sb, r0
	ldr r0, [r0]
	ldrh r0, [r0, #6]
	movs r4, #0xc0
...
_0802DB74:
	...
	bx r0
	.align 2, 0
_0802DB84: .4byte gUnknown_030008A0
_0802DB88: .4byte gUnknown_030015C0
_0802DB8C: .4byte gUnknown_03003B60
...
sub_802DB9C: @ 0x0802DB9C
	push {r4, r5, r6, r7, lr}
	ldr r7, _0802DBF0 @ =gUnknown_03003B60
	ldr r0, [r7]
	ldrh r1, [r0, #6]
	movs r0, #0xc0
	lsls r0, r0, #0x12
	...
	b _0802DC04
	.align 2, 0
_0802DBF0: .4byte gUnknown_03003B60
