...
.if 0
@ --- Start of agb_flash_1m.c ---

	thumb_func_start IdentifyFlash
IdentifyFlash: @ 0x080C70A8
	push {r4, lr}
	...
	lsls r0, r0, #0x10
	lsrs r3, r0, #0x10
	ldr r2, _080C70D0 @ =sSetupInfos
	movs r4, #1
	b _080C70D6
	.align 2, 0
_080C70C8: .4byte 0x04000204
_080C70CC: .4byte 0x0000FFFC
_080C70D0: .4byte sSetupInfos
_080C70D4:
	adds r2, #4
_080C70D6:
	ldr r1, [r2]
	...
	movs r4, #0
_080C70EA:
	ldr r1, _080C7124 @ =ProgramFlashSector
	ldr r0, [r2]
	ldr r0, [r0]
	str r0, [r1]
	ldr r1, _080C7128 @ =EraseFlashChip
	ldr r0, [r2]
	ldr r0, [r0, #4]
	str r0, [r1]
	ldr r1, _080C712C @ =EraseFlashSector
	ldr r0, [r2]
	ldr r0, [r0, #8]
	str r0, [r1]
	ldr r1, _080C7130 @ =WaitForFlashWrite
	ldr r0, [r2]
	ldr r0, [r0, #0xc]
	str r0, [r1]
	ldr r1, _080C7134 @ =gFlashMaxTime
	ldr r0, [r2]
	ldr r0, [r0, #0x10]
	str r0, [r1]
	ldr r1, _080C7138 @ =gFlash
	ldr r0, [r2]
	adds r0, #0x14
	str r0, [r1]
	adds r0, r4, #0
	...
	bx r1
	.align 2, 0
_080C7124: .4byte ProgramFlashSector
_080C7128: .4byte EraseFlashChip
_080C712C: .4byte EraseFlashSector
_080C7130: .4byte WaitForFlashWrite
_080C7134: .4byte gFlashMaxTime
_080C7138: .4byte gFlash

	thumb_func_start WaitForFlashWrite_Common
WaitForFlashWrite_Common: @ 0x080C713C
	push {r4, r5, r6, r7, lr}
	mov r7, r8
	push {r7}
	adds r4, r0, #0
	...
	adds r0, r4, #0
	bl StartFlashTimer
	ldr r7, _080C7164 @ =PollFlashStatus
	movs r0, #0xc0
	lsls r0, r0, #8
	orrs r4, r0
	lsls r4, r4, #0x10
	b _080C7188
	.align 2, 0
_080C7164: .4byte PollFlashStatus
_080C7168:
	ldr r0, _080C7180 @ =gFlash
	ldr r0, [r0]
	ldrb r0, [r0, #0x14]
	cmp r0, #0xc2
	bne _080C7178
...
_080C7188:
	...
	cmp r0, r6
	beq _080C71B0
	ldr r0, _080C71C0 @ =gFlashTimeoutFlag
	ldrb r0, [r0]
	cmp r0, #0
	beq _080C7188
	ldr r1, [r7]
...
_080C71B0:
	...
	bx r1
	.align 2, 0
_080C71C0: .4byte gFlashTimeoutFlag

@ --- End of agb_flash_1m ---

@ --- Start of agb_flash_mx ---

	thumb_func_start EraseFlashChip_MX
EraseFlashChip_MX: @ 0x080C71C4
	push {r4, r5, r6, lr}
	sub sp, #0x40
	...
	mov r0, sp
	bl SetReadFlash1
	ldr r0, _080C7234 @ =WaitForFlashWrite
	movs r1, #0xe0
	lsls r1, r1, #0x14
	ldr r3, [r0]
	movs r0, #3
...
EraseFlashSector_MX: @ 0x080C7238
	...
	mov r0, sp
	bl SetReadFlash1
	ldr r0, _080C72BC @ =WaitForFlashWrite
	ldr r3, [r0]
	movs r0, #2
	adds r1, r4, #0
	movs r2, #0xff
...
_080C72B0: .4byte gFlash
_080C72B4: .4byte 0x0E005555
_080C72B8: .4byte 0x0E002AAA
_080C72BC: .4byte WaitForFlashWrite
_080C72C0:
...
ProgramByte: @ 0x080C72D4
	...
	ldrb r2, [r0]
	strb r2, [r1]
	ldr r3, _080C7308 @ =WaitForFlashWrite
	ldrb r2, [r0]
	ldr r3, [r3]
	movs r0, #1
	bl _call_via_r3
...
_080C7308: .4byte WaitForFlashWrite

	thumb_func_start ProgramFlashSector_MX
ProgramFlashSector_MX: @ 0x080C730C
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
...
sub_80C7430: @ 0x080C7430
	push {lr}
	adds r2, r0, #0
	ldr r0, _080C743C @ =gFlash
	ldr r0, [r0]
	ldr r1, [r0, #4]
	b _080C7442
	.align 2, 0
_080C743C: .4byte gFlash
_080C7440:
	subs r1, #1
_080C7442:
	cmp r1, #0
...
@ --- Start of agb_flash_sst ---

	thumb_func_start ProgramFlashSector_SST
ProgramFlashSector_SST: @ 0x080C746C
	push {r4, r5, r6, r7, lr}
	sub sp, #0x40
	adds r7, r1, #0
	lsls r0, r0, #0x10
	lsrs r4, r0, #0x10
	ldr r0, _080C7484 @ =gFlash
	ldr r0, [r0]
	ldrh r0, [r0, #0xa]
	cmp r4, r0
	blo _080C748C
...
@ --- End of agb_flash_sst ---
.endif

@ --- Start of libagbsyscall ---
...
LZ77UnCompWram: @ 0x080C7530
	svc #0x11
	bx lr

	thumb_func_start MultiBoot_4Players
MultiBoot_4Players: @ 0x080C7534
	movs r1, #1
	svc #0x25
	bx lr
	.align 2, 0
...
_080C7554: .4byte gUnknown_03007F00
	...
	thumb_func_start SetBIASLevel_000
SetBIASLevel_000: @ 0x080C7558
	movs r0, #0
	svc #0x19
	bx lr
	.align 2, 0

	thumb_func_start SetBIASLevel_200
SetBIASLevel_200: @ 0x080C7560
	movs r0, #1
	svc #0x19
	bx lr
	.align 2, 0
