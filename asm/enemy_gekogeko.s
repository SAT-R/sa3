...
.if 01
	thumb_func_start Task_GekoGeko
Task_GekoGeko: @ 0x08059964
	push {r4, r5, r6, lr}
...
_08059A0A:
	...
	beq _08059A3C
_08059A1C:
	ldr r1, _08059A30 @ =sTileInfoGekoGeko
	ldrh r0, [r1, #8]
	strh r0, [r5, #0xc]
	ldrb r0, [r1, #0xa]
	strb r0, [r5, #0x1a]
	...
	b _08059A5C
	.align 2, 0
_08059A30: .4byte sTileInfoGekoGeko
...
_08059A3C:
	...
	cmp r0, #0
	bne _08059A5E
	ldr r1, _08059A64 @ =sTileInfoGekoGeko
	ldrh r0, [r1, #0x10]
	strh r0, [r5, #0xc]
	ldrb r0, [r1, #0x12]
	strb r0, [r5, #0x1a]
...
_08059A5E:
	...
	bx r0
	.align 2, 0
_08059A64: .4byte sTileInfoGekoGeko
...
_08059A98:
	...
	adds r2, r5, r0
	ldr r1, _08059AD8 @ =sTileInfoGekoGeko
	ldrh r0, [r1]
	strh r0, [r2, #0xc]
	ldrb r0, [r1, #2]
	strb r0, [r2, #0x1a]
	...
	bl CpuSet
	ldr r1, [r6]
	ldr r0, _08059AE4 @ =Task_GekoGeko
	str r0, [r1, #8]
_08059ACC:
	add sp, #4
	pop {r4, r5, r6}
...
_08059AD8: .4byte sTileInfoGekoGeko
_08059ADC: .4byte 0x03000058
_08059AE0: .4byte 0x01000002
_08059AE4: .4byte Task_GekoGeko
...
_08059BEE:
	...
	ldr r1, [r0]
	ldr r0, _08059C10 @ =Task_GekoGeko
	str r0, [r1, #8]
_08059C02:
	pop {r4, r5, r6}
	pop {r0}
