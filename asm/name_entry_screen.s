...
.endif
	...
	thumb_func_start Task_8092690
Task_8092690: @ 0x08092690
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_08092AC4: .4byte 0x0000FFFF
	...
	thumb_func_start Task_8092AC8
Task_8092AC8: @ 0x08092AC8
	push {r4, r5, r6, r7, lr}
	mov r7, r8
	push {r7}
	sub sp, #4
