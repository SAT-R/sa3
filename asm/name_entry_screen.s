...
@ --- split ---
	...
	thumb_func_start CreateNameEntryScreen
CreateNameEntryScreen: @ 0x08091D14
	push {r4, r5, r6, lr}
	sub sp, #8
	adds r5, r0, #0
	lsls r5, r5, #0x18
	...
	adds r0, r2, #0
	strh r0, [r1]
	ldr r0, _08091DB0 @ =Task_NameEntryScreen
	movs r1, #0xe0
	lsls r1, r1, #2
	ldr r2, _08091DB4 @ =0x00000101
	ldr r3, _08091DB8 @ =TaskDestructor_NameEntryScreen
	str r3, [sp]
	movs r3, #0
	bl TaskCreate
	ldrh r6, [r0, #6]
...
_08091DB0: .4byte Task_NameEntryScreen
_08091DB4: .4byte 0x00000101
_08091DB8: .4byte TaskDestructor_NameEntryScreen
...
_08092408: .4byte 0x00002A2A
	...
	thumb_func_start Task_NameEntryScreen
Task_NameEntryScreen: @ 0x0809240C
	push {r4, r5, r6, r7, lr}
