...
_080AD964: .4byte gFlags
	...
	thumb_func_start Task_80AD968
Task_80AD968: @ 0x080AD968
	push {r4, r5, r6, lr}
	sub sp, #4
...
_080AE6C8:
	movs r0, #1
	str r0, [r3]
	ldr r0, _080AE6D4 @ =Task_80AD968
_080AE6CE:
	str r0, [r2, #8]
	pop {r0}
	bx r0
	.align 2, 0
_080AE6D4: .4byte Task_80AD968
