...
CreateEntity_Interactable043: @ 0x08031AD8
	...
	adds r0, r0, r5
	strh r0, [r3, #0x36]
	ldr r0, _08031B50 @ =gUnknown_030008A0
	ldrb r0, [r0, #3]
	cmp r0, #7
	beq _08031B58
	ldrb r0, [r7, #7]
...
_08031B50: .4byte gUnknown_030008A0
...
sub_8031C10: @ 0x08031C10
	...
	lsrs r0, r0, #0x18
	mov sb, r0
	ldr r0, _08031C78 @ =gUnknown_03003B60
	ldr r0, [r0]
	ldrh r1, [r0, #6]
	movs r0, #0xc0
	lsls r0, r0, #0x12
	...
	str r3, [sp, #0x1c]
_08031C48:
	ldr r1, _08031C7C @ =gUnknown_030008A0
	ldrb r0, [r1, #3]
	cmp r0, #7
	bne _08031C58
	ldr r3, [sp, #0x14]
...
_08031C58:
	...
	adds r0, r0, r1
	lsls r0, r0, #4
	ldr r1, _08031C80 @ =gUnknown_030015C0
	adds r5, r0, r1
	b _08031C96
	.align 2, 0
_08031C78: .4byte gUnknown_03003B60
_08031C7C: .4byte gUnknown_030008A0
_08031C80: .4byte gUnknown_030015C0
_08031C84:
	ldr r1, _08031D20 @ =gUnknown_030008A0
	ldrb r0, [r1, #6]
	lsls r1, r0, #2
	adds r1, r1, r0
	lsls r1, r1, #2
	adds r1, r1, r0
	lsls r1, r1, #4
	ldr r0, _08031D24 @ =gUnknown_030015C0
	adds r5, r1, r0
_08031C96:
	adds r0, r5, #0
	adds r0, #0x2b
...
_08031D0A:
	...
	b _0803203C
	.align 2, 0
_08031D20: .4byte gUnknown_030008A0
_08031D24: .4byte gUnknown_030015C0
_08031D28:
	movs r0, #0x80
	lsls r0, r0, #0xb
	ands r0, r2
...
_08031ECC:
	movs r1, #0x1a
	ldrsh r0, [r5, r1]
	ldr r3, _08031F18 @ =gUnknown_030008A0
	mov sl, r3
	ldrh r1, [r5, #0x20]
	mov ip, r1
	cmp r0, #0
...
_08031F18: .4byte gUnknown_030008A0
_08031F1C:
	subs r0, r3, r4
	cmp r0, #0x13
	bgt _08031F86
...
sub_803213C: @ 0x0803213C
	...
	lsls r0, r0, #3
	ands r5, r0
	ldr r0, _08032178 @ =gUnknown_030008A0
	ldrb r0, [r0, #3]
	cmp r0, #7
	beq _08032194
	cmp r2, #0
	...
	b _080321A8
	.align 2, 0
_08032178: .4byte gUnknown_030008A0
...
sub_80321D8: @ 0x080321D8
	...
	mov r6, r8
	push {r6, r7}
	ldr r0, _08032228 @ =gUnknown_03003B60
	ldr r0, [r0]
	ldrh r1, [r0, #6]
	movs r0, #0xc0
	lsls r0, r0, #0x12
	...
	bne _08032274
	movs r1, #0
	ldr r6, _08032230 @ =gUnknown_030015C0
_08032212:
	lsls r0, r1, #0x10
	adds r5, r0, #0
	cmp r5, #0
	...
	b _08032238
	.align 2, 0
_08032228: .4byte gUnknown_03003B60
_0803222C: .4byte 0x0300000C
_08032230: .4byte gUnknown_030015C0
_08032234:
	ldr r0, _0803226C @ =gUnknown_030008A0
	ldrb r1, [r0, #6]
_08032238:
	lsls r0, r1, #2
	adds r0, r0, r1
	...
	mov r1, sb
	strb r0, [r1]
	ldr r0, _08032270 @ =gUnknown_03003B60
	ldr r0, [r0]
	bl sub_80BCF8C
	b _08032290
	.align 2, 0
_0803226C: .4byte gUnknown_030008A0
_08032270: .4byte gUnknown_03003B60
_08032274:
...
Task_Interactable043: @ 0x080322B4
	push {lr}
	ldr r0, _080322D0 @ =gUnknown_03003B60
	ldr r0, [r0]
	ldrh r0, [r0, #6]
	...
	bx r0
	.align 2, 0
_080322D0: .4byte gUnknown_03003B60
