...
.endif
	...
	thumb_func_start Task_80182D4
Task_80182D4: @ 0x080182D4
	push {r4, r5, r6, lr}
...
_08018398: .4byte 0xFFFFFBFF
	...
	thumb_func_start Task_801839C_E0
Task_801839C_E0: @ 0x0801839C
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_0801869A:
	...
	thumb_func_start Task_80186A0_CC
Task_80186A0_CC: @ 0x080186A0
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
...
_08018AF4: .4byte 0xFFFFF7FF
	...
	thumb_func_start Task_8018AF8
Task_8018AF8: @ 0x08018AF8
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
...
_0801923C: .4byte 0xFFFFF7FF
	...
	thumb_func_start Task_8019240
Task_8019240: @ 0x08019240
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
TaskDestructor_8019340: @ 0x08019340
	...
	thumb_func_start TaskDestructor_8019354
TaskDestructor_8019354: @ 0x08019354
	push {lr}
	ldrh r0, [r0, #6]
	movs r1, #0xc0
	lsls r1, r1, #0x12
	...
	thumb_func_start TaskDestructor_8019368
TaskDestructor_8019368: @ 0x08019368
	push {lr}
	ldrh r0, [r0, #6]
	movs r1, #0xc0
	lsls r1, r1, #0x12
...
TaskDestructor_TagAction: @ 0x080193E8
	...
	thumb_func_start TaskDestructor_80193EC
TaskDestructor_80193EC: @ 0x080193EC
	push {lr}
	ldrh r0, [r0, #6]
	movs r1, #0xc0
	lsls r1, r1, #0x12
...
sub_8019414: @ 0x08019414
	...
	thumb_func_start TaskDestructor_8019428
TaskDestructor_8019428: @ 0x08019428
	push {lr}
	ldrh r0, [r0, #6]
	movs r1, #0xc0
	lsls r1, r1, #0x12
...
sub_8019450: @ 0x08019450
	...
	thumb_func_start TaskDestructor_8019464
TaskDestructor_8019464: @ 0x08019464
	push {lr}
	ldrh r0, [r0, #6]
	movs r1, #0xc0
	lsls r1, r1, #0x12
...
sub_8019478: @ 0x08019478
	...
	thumb_func_start TaskDestructor_801948C
TaskDestructor_801948C: @ 0x0801948C
	push {lr}
	ldrh r0, [r0, #6]
	movs r1, #0xc0
	lsls r1, r1, #0x12
	...
	thumb_func_start TaskDestructor_80194A0
TaskDestructor_80194A0: @ 0x080194A0
	push {lr}
	ldrh r0, [r0, #6]
	movs r1, #0xc0
	lsls r1, r1, #0x12
	...
	thumb_func_start TaskDestructor_80194B4
TaskDestructor_80194B4: @ 0x080194B4
	push {lr}
	ldrh r0, [r0, #6]
	movs r1, #0xc0
	lsls r1, r1, #0x12
	...
	thumb_func_start TaskDestructor_80194C8
TaskDestructor_80194C8: @ 0x080194C8
	push {lr}
	ldrh r0, [r0, #6]
	movs r1, #0xc0
	lsls r1, r1, #0x12
...
sub_80194F0: @ 0x080194F0
	...
	thumb_func_start TaskDestructor_8019504
TaskDestructor_8019504: @ 0x08019504
	push {lr}
	ldrh r0, [r0, #6]
	movs r1, #0xc0
	lsls r1, r1, #0x12
...
_080195C8: .4byte gCamera
	...
	thumb_func_start Task_80195CC
Task_80195CC: @ 0x080195CC
	push {r4, lr}
...
_08019624: .4byte gCamera
	...
	thumb_func_start Task_8019628
Task_8019628: @ 0x08019628
	push {r4, r5, lr}
...
_0801A11C: .4byte sub_801A280
	...
	thumb_func_start Player_Sonic_TrickUp
Player_Sonic_TrickUp: @ 0x0801A120
	push {r4, r5, lr}
	adds r4, r0, #0
	bl Player_800D880
	adds r0, r4, #0
...
_0801A178: .4byte sub_8019F80
	...
	thumb_func_start Player_Sonic_BoundAttack
Player_Sonic_BoundAttack: @ 0x0801A17C
	push {r4, r5, lr}
	adds r4, r0, #0
	bl Player_800D880
	adds r0, r4, #0
