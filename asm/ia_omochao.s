...
.if 0
	thumb_func_start Task_80380FC
Task_80380FC: @ 0x080380FC
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
...
_08038210:
	...
	beq _0803823E
	adds r0, r4, #0
	ldr r1, _08038298 @ =Player_8005380
	str r2, [sp]
...
_0803825C:
	...
	ldr r1, [r0]
	ldr r0, _080382A0 @ =Task_OmochaoInit
	str r0, [r1, #8]
	movs r0, #0
	str r0, [r6, #0x5c]
	movs r2, #0
...
_08038298: .4byte Player_8005380
_0803829C: .4byte gCurTask
_080382A0: .4byte Task_OmochaoInit
