...
CreateEntity_Hariisen: @ 0x080611F8
	...
	lsls r4, r4, #0x18
	lsrs r4, r4, #0x18
	ldr r0, _0806131C @ =Task_HariisenMain
	movs r2, #0x84
	lsls r2, r2, #6
	ldr r1, _08061320 @ =TaskDestructor_Hariisen
	str r1, [sp]
	movs r1, #0xec
	movs r3, #0
	bl TaskCreate
...
_080612A6:
	...
	bx r0
	.align 2, 0
_0806131C: .4byte Task_HariisenMain
_08061320: .4byte TaskDestructor_Hariisen
...
_08061470: .4byte gCamera

	thumb_func_start Task_HariisenMain
Task_HariisenMain: @ 0x08061474
	push {r4, r5, r6, r7, lr}
