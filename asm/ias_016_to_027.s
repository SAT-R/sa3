...
Task_802ED40: @ 0x0802ED40
	...
	movs r0, #0
	str r0, [sp, #0x10]
	ldr r0, _0802EDB8 @ =gUnknown_03003B60
	ldr r0, [r0]
	ldrh r1, [r0, #6]
	movs r0, #0xc0
	lsls r0, r0, #0x12
...
_0802ED9C:
	...
	b _0802EDE0
	.align 2, 0
_0802EDB8: .4byte gUnknown_03003B60
...
sub_802F1B8: @ 0x0802F1B8
	...
	push {r6, r7}
	mov sb, r0
	ldr r0, _0802F200 @ =gUnknown_03003B60
	ldr r0, [r0]
	ldrh r1, [r0, #6]
	movs r0, #0xc0
	lsls r0, r0, #0x12
...
_0802F1D8:
	...
	b _0802F218
	.align 2, 0
_0802F200: .4byte gUnknown_03003B60
...
_0802F27C:
	...
	mov r1, r8
	strb r0, [r1]
	ldr r0, _0802F2B4 @ =gUnknown_03003B60
	ldr r0, [r0]
	bl sub_80BCF8C
	movs r0, #1
	b _0802F2BA
...
_0802F2B4: .4byte gUnknown_03003B60
_0802F2B8:
	movs r0, #0
_0802F2BA:
	pop {r3, r4}
...
sub_802F2C8: @ 0x0802F2C8
	push {r4, r5, r6, lr}
	ldr r6, _0802F2FC @ =gUnknown_03003B60
	ldr r0, [r6]
	ldrh r0, [r0, #6]
...
_0802F2EC:
	...
	b _0802F316
	.align 2, 0
_0802F2FC: .4byte gUnknown_03003B60
...
sub_802F368: @ 0x0802F368
	...
	push {r5, r6, r7}
	sub sp, #8
	ldr r0, _0802F3B8 @ =gUnknown_03003B60
	ldr r0, [r0]
	ldrh r1, [r0, #6]
	movs r0, #0xc0
	lsls r0, r0, #0x12
...
_0802F3AA:
	...
	b _0802F3CE
	.align 2, 0
_0802F3B8: .4byte gUnknown_03003B60
...
_0802F626:
	...
	movs r0, #0xff
	strb r0, [r4]
	ldr r0, _0802F690 @ =gUnknown_03003B60
	ldr r1, [r0]
...
_0802F690: .4byte gUnknown_03003B60
...
sub_802F698: @ 0x0802F698
	...
	push {r5, r6, r7}
	sub sp, #8
	ldr r0, _0802F6F0 @ =gUnknown_03003B60
	ldr r0, [r0]
	ldrh r1, [r0, #6]
	movs r0, #0xc0
	lsls r0, r0, #0x12
...
_0802F6E0:
	...
	b _0802F706
	.align 2, 0
_0802F6F0: .4byte gUnknown_03003B60
