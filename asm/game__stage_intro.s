...
@ Seems to create the Stage Intro graphics?
	thumb_func_start CraeteStageIntro
CraeteStageIntro: @ 0x08056B78
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_08056CFE:
	...
	ldrb r6, [r0, #0xa]
_08056D0A:
	ldr r0, _08056D7C @ =Task_8057FE8
	movs r1, #0xb8
	lsls r1, r1, #1
	movs r2, #0x84
	lsls r2, r2, #6
	ldr r3, _08056D80 @ =TaskDestructor_StageIntro
	str r3, [sp]
	movs r3, #0
	bl TaskCreate
	ldrh r1, [r0, #6]
...
_08056D7C: .4byte Task_8057FE8
_08056D80: .4byte TaskDestructor_StageIntro
