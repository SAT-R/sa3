...
@ Options
	thumb_func_start CreateOptions
CreateOptions: @ 0x0808AF44
	push {r4, r5, r6, lr}
	sub sp, #8
	adds r4, r0, #0
	lsls r4, r4, #0x10
	...
	adds r0, r2, #0
	strh r0, [r1]
	ldr r0, _0808AF88 @ =Task_OptionsInit
	ldr r1, _0808AF8C @ =0x00000464
	movs r2, #0x80
	lsls r2, r2, #1
	ldr r3, _0808AF90 @ =TaskDestructor_Options
	str r3, [sp]
	movs r3, #0
	bl TaskCreate
	ldrh r1, [r0, #6]
...
_0808AF88: .4byte Task_OptionsInit
_0808AF8C: .4byte 0x00000464
_0808AF90: .4byte TaskDestructor_Options
_0808AF94:
	adds r0, r5, #0
	bl sub_808B0A4
_0808AF9A:
...
_0808B290: .4byte 0xFFFF8800
	...
	thumb_func_start Task_808B294
Task_808B294: @ 0x0808B294
	push {r4, r5, r6, r7, lr}
...
_0808B36C:
	...
	bne _0808B388
	ldr r1, [r7]
	ldr r0, _0808B384 @ =Task_808BAA8
	b _0808B38C
	.align 2, 0
_0808B380: .4byte 0x00003FFF
_0808B384: .4byte Task_808BAA8
_0808B388:
	ldr r1, [r7]
	ldr r0, _0808B394 @ =Task_808BCD8
_0808B38C:
	str r0, [r1, #8]
_0808B38E:
	pop {r4, r5, r6, r7}
	...
	bx r0
	.align 2, 0
_0808B394: .4byte Task_808BCD8

	thumb_func_start Task_808B398
Task_808B398: @ 0x0808B398
	push {r4, r5, r6, lr}
