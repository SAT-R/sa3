...
.arm
	...
	thumb_func_start Options_Difficulty
Options_Difficulty: @ 0x0808F664
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
	...
	lsls r4, r4, #0x10
	lsrs r4, r4, #0x10
	ldr r0, _0808F730 @ =Task_Options_Difficulty_Init
	movs r1, #0x82
	lsls r1, r1, #1
	movs r2, #0x80
	lsls r2, r2, #1
	ldr r3, _0808F734 @ =TaskDestructor_Options_Difficulty
	str r3, [sp]
	movs r3, #0
	bl TaskCreate
	ldrh r1, [r0, #6]
...
_0808F6B4:
	...
	bx r0
	.align 2, 0
_0808F730: .4byte Task_Options_Difficulty_Init
_0808F734: .4byte TaskDestructor_Options_Difficulty
