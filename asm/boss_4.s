...
_0806F396:
	...
	thumb_func_start Task_EggCube_806F3A0
Task_EggCube_806F3A0: @ 0x0806F3A0
	push {r4, r5, r6, lr}
	sub sp, #0x10
...
_0806F9FC:
	...
	thumb_func_start sub_806FA0C
sub_806FA0C: @ 0x0806FA0C
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
...
_0806FB22:
	...
	thumb_func_start SpawnGuardEnemy
SpawnGuardEnemy: @ 0x0806FB38
	push {r4, r5, r6, r7, lr}
	sub sp, #4
	adds r4, r0, #0
	lsls r1, r1, #0x18
	lsrs r6, r1, #0x18
	ldr r0, _0806FBA4 @ =Task_Guard_806FC2C
	movs r2, #0x8c
	lsls r2, r2, #6
	movs r1, #0
	str r1, [sp]
...
_0806FB82:
	...
	b _0806FBC6
	.align 2, 0
_0806FBA4: .4byte Task_Guard_806FC2C
...
_0806FBC6:
	...
	str r0, [r5]
	movs r1, #0
	ldr r0, _0806FC28 @ =0x0000049F @ ANIM_GUARD
	strh r0, [r5, #0xc]
	strb r1, [r5, #0x1a]
	subs r0, #0x1f
	strh r0, [r5, #0x14]
...
_0806FC28: .4byte 0x0000049F
	...
	thumb_func_start Task_Guard_806FC2C
Task_Guard_806FC2C: @ 0x0806FC2C
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_0806FCEC:
	...
	asrs r1, r1, #0x10
	str r2, [sp]
	ldr r0, _0806FE2C @ =sa2__sub_801EE64
	str r0, [sp, #4]
	adds r0, r3, #0
	movs r2, #1
	movs r3, #8
...
_0806FE2C: .4byte sa2__sub_801EE64
