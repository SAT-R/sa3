...
.arm
	...
	thumb_func_start CreateEggCube
CreateEggCube: @ 0x0806EADC
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
	...
	mov sb, r0
	adds r4, r2, #0
	ldr r0, _0806EC2C @ =Task_EggCubeInit
	movs r1, #0xc4
	lsls r1, r1, #1
	movs r2, #0x84
	lsls r2, r2, #6
	ldr r3, _0806EC30 @ =TaskDestructor_EggCube
	str r3, [sp]
	movs r3, #0
	bl TaskCreate
	str r0, [sp, #4]
	...
	bx r1
	.align 2, 0
_0806EC2C: .4byte Task_EggCubeInit
_0806EC30: .4byte TaskDestructor_EggCube
