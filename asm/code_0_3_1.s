...
sub_802AFFC: @ 0x0802AFFC
	...
	movs r0, #0xe
	ldrsh r2, [r4, r0]
	ldr r0, _0802B040 @ =sa2__sub_801EC3C
	str r0, [sp]
	adds r0, r3, #0
	adds r1, r6, #0
	movs r3, #8
	...
	b _0802B080
	.align 2, 0
_0802B040: .4byte sa2__sub_801EC3C
_0802B044:
	cmp r0, #0
	bge _0802B08C
	...
	movs r3, #8
	rsbs r3, r3, #0
	ldr r1, _0802B0A0 @ =sa2__sub_801EC3C
	str r1, [sp]
	adds r1, r6, #0
	bl sa2__sub_801F100
	cmp r0, #0
...
_0802B0A0: .4byte sa2__sub_801EC3C
...
sub_802B0A4: @ 0x0802B0A4
	...
	movs r3, #8
	rsbs r3, r3, #0
	ldr r1, _0802B158 @ =sa2__sub_801EC3C
	str r1, [sp]
	adds r1, r7, #0
	bl sa2__sub_801F100
	cmp r0, #0
...
_0802B0FC:
	...
	movs r0, #0xe
	ldrsh r2, [r4, r0]
	ldr r0, _0802B158 @ =sa2__sub_801EC3C
	str r0, [sp]
	adds r0, r6, #0
	adds r1, r7, #0
	movs r3, #8
...
_0802B144:
	...
	bx r0
	.align 2, 0
_0802B158: .4byte sa2__sub_801EC3C
