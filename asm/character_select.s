...
sub_80988B0: @ 0x080988B0
	...
	strb r0, [r4, #6]
	bl sub_800214C
	ldr r1, _080989AC @ =gLoadedSaveGame
	movs r2, #0xd9
	lsls r2, r2, #2
	adds r0, r1, r2
	ldrb r0, [r0]
	...
	ldr r0, [r1, #8]
	bl sub_80003B8
	ldr r2, _080989AC @ =gLoadedSaveGame
	ldrh r1, [r2, #0x34]
	movs r0, #1
	ands r0, r1
	cmp r0, #0
...
_080989AC: .4byte gLoadedSaveGame
...
_080989D4:
	ldr r0, _080989FC @ =gLoadedSaveGame
	ldrb r1, [r0, #0x12]
	lsls r0, r1, #2
	adds r0, r0, r1
	lsls r0, r0, #0x11
...
_080989EE:
	...
	bx r1
	.align 2, 0
_080989FC: .4byte gLoadedSaveGame
...
_08098A3A:
	...
	ldr r0, _08098B40 @ =gLoadedSaveGame
	movs r2, #0xd9
	lsls r2, r2, #2
	adds r0, r0, r2
	ldrb r0, [r0]
...
_08098B40: .4byte gLoadedSaveGame
...
sub_8098CFC: @ 0x08098CFC
	...
	movs r0, #0
	bl MultiSioInit
	ldr r0, _08098D8C @ =gMultiSioEnabled
	strb r4, [r0]
	ldrb r0, [r7, #8]
	cmp r0, #0
	beq _08098D90
...
_08098D8C: .4byte gMultiSioEnabled
_08098D90:
	ldrb r0, [r7, #7]
	cmp r0, #0
	bne _08098DBA
...
_08098DD6:
	...
	thumb_func_start Task_8098DE4
Task_8098DE4: @ 0x08098DE4
	push {r4, r5, r6, lr}
...
_08098F00:
	...
	adds r0, r3, r0
	ldrb r1, [r0]
	ldr r2, _08098F48 @ =gLoadedSaveGame
...
_08098F7C:
	...
	ldr r1, [r0]
	ldr r0, _08098F90 @ =Task_8099300
	b _08098FE0
	.align 2, 0
_08098F8C: .4byte gCurTask
_08098F90: .4byte Task_8099300
_08098F94:
	ldrb r1, [r4, #3]
	subs r0, r2, #1
	cmp r1, r0
...
sub_80990B0: @ 0x080990B0
	...
	strh r1, [r2, #0x18]
	strh r1, [r2, #0x1a]
	ldr r1, _080990F4 @ =gLoadedSaveGame
...
_080990F4: .4byte gLoadedSaveGame
...
_0809910A:
	...
	movs r0, #4
	strb r0, [r4, #0xb]
	ldr r1, _08099160 @ =gLoadedSaveGame
...
_08099160: .4byte gLoadedSaveGame
...
_08099170:
	...
	str r0, [r1]
	ldr r0, _08099190 @ =gObjPalette + 0xC0
	str r0, [r1, #4]
...
_08099190: .4byte gObjPalette + 0xC0
...
_080991C0:
	...
	adds r0, r0, r1
	str r0, [r2]
	ldr r0, _080991F4 @ =gObjPalette + 0xC0
	str r0, [r2, #4]
...
_080991F4: .4byte gObjPalette + 0xC0
_080991F8: .4byte 0x80000010
_080991FC: .4byte gFlags

	thumb_func_start Task_8099200
Task_8099200: @ 0x08099200
	push {r4, lr}
...
_080992F8:
	...
	thumb_func_start Task_8099300
Task_8099300: @ 0x08099300
	push {r4, r5, lr}
	sub sp, #4
...
_08099478: .4byte Task_809947C

	thumb_func_start Task_809947C
Task_809947C: @ 0x0809947C
	push {r4, r5, r6, lr}
...
_08099514:
	...
	lsls r0, r0, #7
	str r0, [r4, #0x40]
	ldr r1, _08099554 @ =gLoadedSaveGame
...
_08099554: .4byte gLoadedSaveGame
...
_08099564:
	...
	str r0, [r1]
	ldr r0, _08099584 @ =gObjPalette + 0xE0
	str r0, [r1, #4]
...
_08099584: .4byte gObjPalette + 0xE0
...
_080995B4:
	...
	adds r0, r0, r1
	str r0, [r2]
	ldr r0, _08099614 @ =gObjPalette + 0xE0
	str r0, [r2, #4]
...
_080995CE:
	...
	strh r1, [r2, #0x18]
	strh r1, [r2, #0x1a]
	ldr r1, _0809962C @ =gLoadedSaveGame
...
_08099614: .4byte gObjPalette + 0xE0
...
_0809962C: .4byte gLoadedSaveGame
...
_0809967C: .4byte Task_8099680

	thumb_func_start Task_8099680
Task_8099680: @ 0x08099680
	push {r4, r5, lr}
