...
const u8 Tileset_zone_final_act_altar_emerald_fg[] = INCBIN_U8("data/maps/zone_final/act_altar_emerald/tilemaps/fg/tileset.4bpp",
                                                               "data/maps/zone_final/act_altar_emerald/tilemaps/fg/tileset_anim.4bpp");
...
const u16 CollFlags_zone_final_act_altar_emerald_fg[] = INCBIN_U16("data/maps/zone_final/act_altar_emerald/tilemaps/fg/flags.coll");
...
ALIGNED(4) const struct MapHeader zone_final_act_altar_emerald_fg0 = 
{
    .tileset = {
        ...
        .tilesSize = sizeof(Tileset_zone_final_act_altar_emerald_fg) - ((8-1) * 0x240),
