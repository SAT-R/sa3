...
const u16 Palette_zone_1_act_bonus_capsule_fg[] = INCBIN_U16("data/maps/zone_1/act_bonus_capsule/tilemaps/fg/palette.gbapal");
...
const u16 Map_zone_1_act_bonus_capsule_fg0[] = INCBIN_U16("data/maps/zone_1/act_bonus_capsule/tilemaps/fg/map_back.bin");

const u16 Map_zone_1_act_bonus_capsule_fg1[] = INCBIN_U16("data/maps/zone_1/act_bonus_capsule/tilemaps/fg/map_front.bin");
...
ALIGNED(4) const struct MapHeader zone_1_act_bonus_capsule_fg0 = 
{
    ...
    .metatileMap = Map_zone_1_act_bonus_capsule_fg0,
    .mapWidth = 3,
    .mapHeight = 2,
};

ALIGNED(4) const struct MapHeader zone_1_act_bonus_capsule_fg1 = 
{
    .h = {
        .xTiles = 12,
        .yTiles = 12,
    ...
    .metatileMap = Map_zone_1_act_bonus_capsule_fg1,
    .mapWidth = 3,
    .mapHeight = 2,
};

const Collision CollHeader_zone_1_act_bonus_capsule_fg = {
    CollHeightMap_zone_1_act_bonus_capsule_fg, CollTileRot_zone_1_act_bonus_capsule_fg,
    Metatiles_zone_1_act_bonus_capsule_fg,
    Map_zone_1_act_bonus_capsule_fg0, Map_zone_1_act_bonus_capsule_fg1,
