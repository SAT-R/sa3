...
const u16 Map_zone_1_act_3_fg0[] = INCBIN_U16("data/maps/zone_1/act_3/tilemaps/fg/map_back.bin");

const u16 Map_zone_1_act_3_fg1[] = INCBIN_U16("data/maps/zone_1/act_3/tilemaps/fg/map_front.bin");
