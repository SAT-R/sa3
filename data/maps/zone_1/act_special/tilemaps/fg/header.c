...
const u16 CollFlags_zone_1_act_special_fg[] = INCBIN_U8("data/maps/zone_1/act_special/tilemaps/fg/flags.coll");
const u16 Metatiles_zone_1_act_special_fg[] = INCBIN_U16("data/maps/zone_1/act_special/tilemaps/fg/metatiles.tilemap2");

const u16 Map_zone_1_act_special_fg0[] = INCBIN_U16("data/maps/zone_1/act_special/tilemaps/fg/map_back.bin");
...
const Collision CollHeader_zone_1_act_special_fg = {
    CollHeightMap_zone_1_act_special_fg, CollTileRot_zone_1_act_special_fg,
    Metatiles_zone_1_act_special_fg,
    Map_zone_1_act_special_fg0, Map_zone_1_act_special_fg1,
