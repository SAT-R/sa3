...
const u8 CollHeightMap_zone_7_act_2_fg[] = INCBIN_U8("data/maps/zone_7/act_2/tilemaps/fg/height_map.coll");
const u8 CollTileRot_zone_7_act_2_fg[] = INCBIN_U8("data/maps/zone_7/act_2/tilemaps/fg/tile_rot.coll");
const u16 CollFlags_zone_7_act_2_fg[] = INCBIN_U8("data/maps/zone_7/act_2/tilemaps/fg/flags.coll");
const u16 Metatiles_zone_7_act_2_fg[] = INCBIN_U16("data/maps/zone_7/act_2/tilemaps/fg/metatiles.tilemap2");

const u16 Map_zone_7_act_2_fg0[] = INCBIN_U16("data/maps/zone_7/act_2/tilemaps/fg/map_back.bin");

const u16 Map_zone_7_act_2_fg1[] = INCBIN_U16("data/maps/zone_7/act_2/tilemaps/fg/map_back.bin");

ALIGNED(4) const struct MapHeader zone_7_act_2_fg0 = 
{
    .h = {
        .xTiles = 12,
        .yTiles = 12,
        ...
        .tilesSize = sizeof(Tileset_zone_7_act_2_fg) - (8 * 0x300),
...
ALIGNED(4) const struct MapHeader zone_7_act_2_fg1 = 
{
    .h = {
        .xTiles = 12,
        .yTiles = 12,
...
const Collision CollHeader_zone_7_act_2_fg = {
    CollHeightMap_zone_7_act_2_fg, CollTileRot_zone_7_act_2_fg,
    Metatiles_zone_7_act_2_fg,
    Map_zone_7_act_2_fg0, Map_zone_7_act_2_fg1,
