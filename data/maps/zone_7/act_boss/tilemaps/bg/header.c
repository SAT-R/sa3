...
const Tilemap zone_7_act_boss_bg1 = {
    ...
    .animFrameCount = 0,
    .animDelay = 0,
    .tiles = Tiles_zone_7_act_boss_bg1,
    .tilesSize = sizeof(Tiles_zone_7_act_boss_bg1) - (0 * 0x00),
    .palette = Palette_zone_7_act_boss_bg1,
    .palOffset = 0,
    .palLength = sizeof(Palette_zone_7_act_boss_bg1) / sizeof(u16),
    .map = Tilemap_zone_7_act_boss_bg1,
};
