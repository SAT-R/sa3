...
const u16 Map_zone_7_act_bonus_capsule_fg0[] = INCBIN_U16("data/maps/zone_7/act_bonus_capsule/tilemaps/fg/map_back.bin");

const u16 Map_zone_7_act_bonus_capsule_fg1[] = INCBIN_U16("data/maps/zone_7/act_bonus_capsule/tilemaps/fg/map_front.bin");
...
const Collision CollHeader_zone_7_act_bonus_capsule_fg = {
    CollHeightMap_zone_7_act_bonus_capsule_fg, CollTileRot_zone_7_act_bonus_capsule_fg,
    Metatiles_zone_7_act_bonus_capsule_fg,
    Map_zone_7_act_bonus_capsule_fg0, Map_zone_7_act_bonus_capsule_fg1,
