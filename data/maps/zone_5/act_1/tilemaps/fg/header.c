...
const u16 CollFlags_zone_5_act_1_fg[] = INCBIN_U8("data/maps/zone_5/act_1/tilemaps/fg/flags.coll");
const u16 Metatiles_zone_5_act_1_fg[] = INCBIN_U16("data/maps/zone_5/act_1/tilemaps/fg/metatiles.tilemap2");

const u16 Map_zone_5_act_1_fg0[] = INCBIN_U16("data/maps/zone_5/act_1/tilemaps/fg/map_back.bin");
...
ALIGNED(4) const struct MapHeader zone_5_act_1_fg0 = 
{
    .h = {
        ...
        .tilesSize = sizeof(Tileset_zone_5_act_1_fg) - (12 * 0x80),
...
const Collision CollHeader_zone_5_act_1_fg = {
