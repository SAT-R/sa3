...
const u8 CollHeightMap_zone_5_act_boss_fg[] = INCBIN_U8("data/maps/zone_5/act_boss/tilemaps/fg/height_map.coll");
const u8 CollTileRot_zone_5_act_boss_fg[] = INCBIN_U8("data/maps/zone_5/act_boss/tilemaps/fg/tile_rot.coll");
const u16 CollFlags_zone_5_act_boss_fg[] = INCBIN_U8("data/maps/zone_5/act_boss/tilemaps/fg/flags.coll");
const u16 Metatiles_zone_5_act_boss_fg[] = INCBIN_U16("data/maps/zone_5/act_boss/tilemaps/fg/metatiles.tilemap2");

const u16 Map_zone_5_act_boss_fg0[] = INCBIN_U16("data/maps/zone_5/act_boss/tilemaps/fg/map_back.bin");

const u16 Map_zone_5_act_boss_fg1[] = INCBIN_U16("data/maps/zone_5/act_boss/tilemaps/fg/map_front.bin");
...
ALIGNED(4) const struct MapHeader zone_5_act_boss_fg0 = 
{
    .h = {
        ...
        .tilesSize = sizeof(Tileset_zone_5_act_boss_fg) - (12 * 0x80),
...
const Collision CollHeader_zone_5_act_boss_fg = {
    CollHeightMap_zone_5_act_boss_fg, CollTileRot_zone_5_act_boss_fg,
    Metatiles_zone_5_act_boss_fg,
    Map_zone_5_act_boss_fg0, Map_zone_5_act_boss_fg1,
