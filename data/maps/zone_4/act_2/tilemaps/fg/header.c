...
const u8 CollHeightMap_zone_4_act_2_fg[] = INCBIN_U8("data/maps/zone_4/act_2/tilemaps/fg/height_map.coll");
const u8 CollTileRot_zone_4_act_2_fg[] = INCBIN_U8("data/maps/zone_4/act_2/tilemaps/fg/tile_rot.coll");
const u16 CollFlags_zone_4_act_2_fg[] = INCBIN_U8("data/maps/zone_4/act_2/tilemaps/fg/flags.coll");
const u16 Metatiles_zone_4_act_2_fg[] = INCBIN_U16("data/maps/zone_4/act_2/tilemaps/fg/metatiles.tilemap2");

const u16 Map_zone_4_act_2_fg0[] = INCBIN_U16("data/maps/zone_4/act_2/tilemaps/fg/map_back.bin");
...
ALIGNED(4) const struct MapHeader zone_4_act_2_fg0 = 
{
    .h = {
        ...
        .tilesSize = sizeof(Tileset_zone_4_act_2_fg) - (2 * 0x400),
...
const Collision CollHeader_zone_4_act_2_fg = {
