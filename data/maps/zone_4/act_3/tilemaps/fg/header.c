...
const u16 Map_zone_4_act_3_fg0[] = INCBIN_U16("data/maps/zone_4/act_3/tilemaps/fg/map_front.bin");

const u16 Map_zone_4_act_3_fg1[] = INCBIN_U16("data/maps/zone_4/act_3/tilemaps/fg/map_back.bin");
...
ALIGNED(4) const struct MapHeader zone_4_act_3_fg0 = 
{
    .tileset = {
        ...
        .tilesSize = sizeof(Tileset_zone_4_act_1_fg) - ((2-1) * 0x400),
...
const Collision CollHeader_zone_4_act_3_fg = { CollHeightMap_zone_4_act_1_fg,
