...
const u8 CollHeightMap_zone_6_act_boss_fg[] = INCBIN_U8("data/maps/zone_6/act_boss/tilemaps/fg/height_map.coll");
const u8 CollTileRot_zone_6_act_boss_fg[] = INCBIN_U8("data/maps/zone_6/act_boss/tilemaps/fg/tile_rot.coll");
const u16 CollFlags_zone_6_act_boss_fg[] = INCBIN_U8("data/maps/zone_6/act_boss/tilemaps/fg/flags.coll");
...
ALIGNED(4) const struct MapHeader zone_6_act_boss_fg0 = 
{
    .h = {
        .xTiles = 12,
        .yTiles = 12,
        ...
        .tilesSize = sizeof(Tileset_zone_6_act_boss_fg) - (0 * 0x00),
...
ALIGNED(4) const struct MapHeader zone_6_act_boss_fg1 = 
{
    .h = {
        .xTiles = 12,
        .yTiles = 12,
...
const Collision CollHeader_zone_6_act_boss_fg = {
    CollHeightMap_zone_6_act_boss_fg, CollTileRot_zone_6_act_boss_fg,
    Metatiles_zone_6_act_boss_fg,
    Map_zone_6_act_boss_fg0, Map_zone_6_act_boss_fg1,
