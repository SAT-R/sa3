...
const u16 CollFlags_zone_6_act_1_fg[] = INCBIN_U8("data/maps/zone_6/act_1/tilemaps/fg/flags.coll");
const u16 Metatiles_zone_6_act_1_fg[] = INCBIN_U16("data/maps/zone_6/act_1/tilemaps/fg/metatiles.tilemap2");

const u16 Map_zone_6_act_1_fg0[] = INCBIN_U16("data/maps/zone_6/act_1/tilemaps/fg/map_back.bin");

const u16 Map_zone_6_act_1_fg1[] = INCBIN_U16("data/maps/zone_6/act_1/tilemaps/fg/map_front.bin");
...
const Collision CollHeader_zone_6_act_1_fg = {
    CollHeightMap_zone_6_act_1_fg, CollTileRot_zone_6_act_1_fg,
