...
const u8 CollHeightMap_zone_6_act_2_fg[] = INCBIN_U8("data/maps/zone_6/act_2/tilemaps/fg/height_map.coll");
const u8 CollTileRot_zone_6_act_2_fg[] = INCBIN_U8("data/maps/zone_6/act_2/tilemaps/fg/tile_rot.coll");
const u16 CollFlags_zone_6_act_2_fg[] = INCBIN_U8("data/maps/zone_6/act_2/tilemaps/fg/flags.coll");
...
ALIGNED(4) const struct MapHeader zone_6_act_2_fg0 = 
{
    .h = {
        ...
        .tilesSize = sizeof(Tileset_zone_6_act_2_fg) - (8 * 0x640),
...
const Collision CollHeader_zone_6_act_2_fg = {
    CollHeightMap_zone_6_act_2_fg, CollTileRot_zone_6_act_2_fg,
