...
const u16 Map_zone_6_act_bonus_enemy_fg0[] = INCBIN_U16("data/maps/zone_6/act_bonus_enemy/tilemaps/fg/map_front.bin");
const u16 Map_zone_6_act_bonus_enemy_fg1[] = INCBIN_U16("data/maps/zone_6/act_bonus_enemy/tilemaps/fg/map_back.bin");
...
const Collision CollHeader_zone_6_act_bonus_enemy_fg = { CollHeightMap_zone_1_act_bonus_capsule_fg,
