...
const u16 CollFlags_zone_2_act_2_fg[] = INCBIN_U8("data/maps/zone_2/act_2/tilemaps/fg/flags.coll");
const u16 Metatiles_zone_2_act_2_fg[] = INCBIN_U16("data/maps/zone_2/act_2/tilemaps/fg/metatiles.tilemap2");

const u16 Map_zone_2_act_2_fg0[] = INCBIN_U16("data/maps/zone_2/act_2/tilemaps/fg/map_back.bin");

const u16 Map_zone_2_act_2_fg1[] = INCBIN_U16("data/maps/zone_2/act_2/tilemaps/fg/map_front.bin");
...
ALIGNED(4) const struct MapHeader zone_2_act_2_fg0 = 
{
    .h = {
        ...
        .tilesSize = sizeof(Tileset_zone_2_act_2_fg) - (0 * 0x00),
...
const Collision CollHeader_zone_2_act_2_fg = {
