...
const u16 CollFlags_zone_3_act_2_fg[] = INCBIN_U8("data/maps/zone_3/act_2/tilemaps/fg/flags.coll");
...
ALIGNED(4) const struct MapHeader zone_3_act_2_fg0 = 
{
    .h = {
        ...
        .tilesSize = sizeof(Tileset_zone_3_act_2_fg) - (0 * 0x00),
...
const Collision CollHeader_zone_3_act_2_fg = {
