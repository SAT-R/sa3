...
struct EwramNode {
    ...
    /* 0x4 */ s32 state; // It records how much space is corresponding
                         // to this node. When you want to mark it as
                         // occupied/busy, negate it.
    /* 0x8 */ u8 ALIGNED(sizeof(void *)) space[0]; // space for general purposes
};
