...
#define FIRST_ELEM_X ((DISPLAY_CENTER_X - (BAR_WIDTH / 2)) + ANIM_BONUS_UI_BAR_WIDTH)
...
#define COUNTDOWN_DIGIT_X   DISPLAY_CENTER_X
#define COUNTDOWN_DIGIT_Y   DISPLAY_CENTER_Y
