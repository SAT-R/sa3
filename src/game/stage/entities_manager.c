...
static void Task_EntitiesManagerInit(void)
{
    ...
    if (!(gStageFlags & 2)) {
        ...
        if (gCamera.x > em->prevCamX) {
            ...
            if (LEVEL_TO_ZONE(CURRENT_LEVEL) == ZONE_3) {
            ...
            } else if (CURRENT_LEVEL == LEVEL_INDEX(ZONE_4, ACT_2)) {
