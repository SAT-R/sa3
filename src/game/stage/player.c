...
void sub_800D32C(Player *arg0)
{
    ...
    if (var_r3 != 0) {
        ...
        if (temp_r1 == -1) {
            arg0->idleAndCamCounter = -2;
            arg0->qSpeedAirX = var_r3;
            arg0->qSpeedAirY = -0xA00;
        } else if (temp_r1 == -2) {
            arg0->callback = Player_8006F08;
            arg0->moveState |= 4;
        }
    }
    if (!sub_8015064(arg0)) {
