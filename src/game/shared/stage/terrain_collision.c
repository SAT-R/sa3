...
static ALIGNED(8) u32 SA2_LABEL(gUnknown_3000410)[3];
static ALIGNED(8) u32 SA2_LABEL(gUnknown_3000420)[3];
...
s32 SA2_LABEL(sub_801E6D4)(s32 p0, s32 p1, s32 p2, s32 p3, u8 *data, Func801F07C func)
{
    u8 dummy[4];
    u8 *dummy_p;
    u8 *data1;
...
#if (GAME == GAME_SA1)
    typedef s32 r0r1_t;
#elif ((GAME == GAME_SA2) || (GAME == GAME_SA3))
    typedef u32 r0r1_t;
#endif
...
s32 SA2_LABEL(sub_801EF94)(s32 p0, s32 p1, s32 layer)
{
    ...
    if (SA2_LABEL(gUnknown_3000410)[0] == r4) {
        r7 = SA2_LABEL(gUnknown_3000410)[2];
        r0 = SA2_LABEL(gUnknown_3000410)[1];
    } else {
        s32 divRes = Div(r4, TILES_PER_METATILE_AXIS);
        r1 = r4 - (divRes * TILES_PER_METATILE_AXIS);

        SA2_LABEL(gUnknown_3000410)[0] = r4;
        SA2_LABEL(gUnknown_3000410)[1] = divRes;
        SA2_LABEL(gUnknown_3000410)[2] = r1;
    ...
    r4 = p1 >> 3;
    if (SA2_LABEL(gUnknown_3000420)[0] == r4) {
        r5 = SA2_LABEL(gUnknown_3000420)[2];
        r3 = SA2_LABEL(gUnknown_3000420)[1];
    } else {
        s32 divRes = Div(r4, TILES_PER_METATILE_AXIS);
        r1 = r4 - (divRes * TILES_PER_METATILE_AXIS);

        r3 = divRes;
        SA2_LABEL(gUnknown_3000420)[0] = r4;
        SA2_LABEL(gUnknown_3000420)[1] = r3;
        SA2_LABEL(gUnknown_3000420)[2] = r1;
...
{
    DmaFill32(3, 0, &SA2_LABEL(gUnknown_3000410), sizeof(SA2_LABEL(gUnknown_3000410)));
    DmaFill32(3, 0, &SA2_LABEL(gUnknown_3000420), sizeof(SA2_LABEL(gUnknown_3000420)));
}
