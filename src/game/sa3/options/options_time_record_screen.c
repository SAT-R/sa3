...
void sub_8094A98(TimeRecordScreen *trs) {
    ...
    do {
        ...
        temp_r7->x = (s16) ((s32) *(sp18 + temp_r1_2) >> 8);
        temp_r7->y = (s16) ((s32) *(sp1C + temp_r1_2) >> 8);
    ...
    trs->spr414.x = (s16) ((s32) trs->unk78 >> 8);
    trs->spr414.y = (s16) ((s32) trs->unk7C >> 8);
    ...
    do {
        ...
        *var_r1_2 = &(*var_r1_2)[sp28];
        ...
        temp_r7_3->x = (s16) ((s32) trs->unk78 >> 8);
        temp_r7_3->y = (s16) ((s32) trs->unk7C >> 8);
...
void sub_809508C(void) {
    ...
    if (temp_r5 == 0) {
        ...
        gWinRegs[5] = temp_r5;
        gBldRegs.bldY = 0x10;
        temp_r1->unk26 = 0x1000U;
        temp_r1->unk28 = 1U;
    }
    gWinRegs[2] = (((s32) temp_r1->unk54 >> 8) * 0x101) + ((s32) temp_r1->unk2C >> 8);
    if (gBldRegs.bldY != 0) {
        gBldRegs.bldY = (u16) ((u16) temp_r1->unk26 >> 8);
        temp_r0 = temp_r1->unk26 + 0xFFFFFE00;
        temp_r1->unk26 = temp_r0;
        if ((u32) (temp_r0 << 0x10) > 0x0FFF0000U) {
            temp_r1->unk26 = 0U;
        }
    } else {
        temp_r1->unk28 = (u16) gBldRegs.bldY;
        gWinRegs[4] = 0x3110;
...
void sub_809514C(void) {
    ...
    temp_r3 = temp_r2->unk4;
    temp_r2->unk4 = 0U;
    temp_r2->unk24 = 0;
    temp_r2->unk26 = 0;
    temp_r2->unk28 = 0;
    temp_r2->unk1 = 4;
    temp_r2->unk30 = 0x11800;
    temp_r1 = (0x8C - temp_r3) << 8;
    temp_r2->unk34 = temp_r1;
    temp_r2->unk2C = 0x1800;
    temp_r1_2 = temp_r1 + (temp_r3 << 8) + 0xFFFFF400;
    temp_r2->unk54 = temp_r1_2;
...
void sub_80951B0(void) {
    ...
    temp_r2->unk1 = 4;
    temp_r2->unk30 = 0x11800;
    temp_r2->unk34 = 0x6C00;
    temp_r2->unk38 = 0x11800;
    temp_r2->unk3C = 0x6C00;
    temp_r2->unk2C = 0x1800;
    temp_r2->unk54 = 0x8000;
    temp_r2->unk1E = 3;
...
void Task_8095370(void) {
    ...
    sub_8096490((TimeRecordScreen *) temp_r1);
    sub_8096714((TimeRecordScreen *) temp_r1);
    gWinRegs[2] = (((s32) temp_r1->unk54 >> 8) * 0x101) + ((s32) temp_r1->unk2C >> 8);
    if ((u32) gBldRegs.bldY <= 0xFU) {
        gBldRegs.bldY = (u16) ((u16) temp_r1->unk26 >> 8);
        temp_r1->unk26 = (u16) (temp_r1->unk26 + 0x100);
        return;
    }
    temp_r1->unk26 = (u16) (gBldRegs.bldY << 8);
    var_r3 = 0;
    sp0 = temp_r1 + 0x78;
    do {
        temp_r1_2 = var_r3 * 8;
        *(sp0 + temp_r1_2) = (var_r3 << 0xE) + 0xF000;
        *(temp_r1 + 0x7C + temp_r1_2) = (var_r3 << 0xC) + 0x1000;
        *(temp_r1 + 0xF + var_r3) = 0;
        var_r3 += 1;
    } while ((u32) var_r3 <= 4U);
    temp_r1->unk1F = 0;
    temp_r1->unk1E = 0;
...
block_15:
        sub_809673C((TimeRecordScreen *) temp_r1);
        sub_8095E8C((TimeRecordScreen *) temp_r1);
    ...
    case 3:                                         /* switch 2 */
        ...
        var_r0 = temp_r1->unk1E + (temp_r1->unk1F * 0xA) + 3;
block_27:
    ...
    case 4:                                         /* switch 2 */
        ...
        var_r0 = (s32) ((temp_r1->unk1F * 0xA0000) + 0x70000) >> 0x10;
        goto block_27;
    case 5:                                         /* switch 2 */
        var_r1 = 3;
block_32:
...
void sub_8095674(void) {
    ...
    temp_r0 = sub_8096398((TimeRecordScreen *) temp_r1);
    if (temp_r0 == 1) {
        var_r5 = 0x01000000U >> 0x18;
        temp_r1->unk1 = temp_r0;
    }
    if (sub_8096678((TimeRecordScreen *) temp_r1) == 1) {
...
void Task_8095840(TimeRecordScreen *trs) {
    ...
    if (var_r5 == 0xF) {
        ...
        gBldRegs.bldCnt = 0x82;
        gWinRegs[4] = 0x3532;
        gBgScrollRegs[2][0] = ((s32) trs->unk78 >> 8) + 0xF;
        trs->unk68 = 0x8400;
        temp_r1 = trs->unk34;
        trs->unk6C = temp_r1;
        trs->unk70 = 0x7C00;
...
block_15:
        ...
        if (0xC0 & gRepeatedKeys) {
            if (0x40 & gRepeatedKeys) {
                ...
                trs->unk1F = temp_r0_2;
                if ((s32) (s8) temp_r0_2 >= (s32) (s8) trs->filler5[0xF]) {
                    trs->unk1F = 0;
                }
            }
...
block_29:
        ...
        if (0x10 & gRepeatedKeys) {
            ...
            if (temp_r2 == 0) {
                temp_r0_4 = trs->unk1F + 1;
                trs->unk1F = temp_r0_4;
                if ((s32) (s8) temp_r0_4 > 2) {
                    trs->unk1F = (u8) temp_r2;
                    temp_r0_5 = trs->unk1F + 1;
                    trs->unk1F = temp_r0_5;
                    if ((s32) (s8) temp_r0_5 >= (s32) (s8) trs->filler5[0xF]) {
                        trs->unk1F = (u8) temp_r2;
                    }
                }
            } else {
                trs->unk1F = 3;
                trs->unk1F += 1;
                if ((s32) (s8) trs->unk1F > (s32) ((s8) trs->filler5[0xF] - 1)) {
                    trs->unk1F = 0;
                }
            }
        }
...
block_43:
        ...
        if (((s8) trs->unk1F != (s8) temp_r7) || ((s8) trs->unk1F != (s8) temp_r8)) {
            var_r6 = 1;
        }
        if (var_r6 != 0) {
...
block_9:
            ...
            temp_r2_3 = var_r4 + temp_r2;
            *temp_r2_3 -= *(var_r3 + &gUnknown_080D8BD8) << 8;
        }
        temp_r7[var_r5] = var_r3;
        var_r5 += 1;
    } while ((u32) var_r5 <= 4U);
    if ((u32) var_r8 <= 4U) {
        return 0;
...
loop_1:
    var_r8 = 0;
    if (((u32) trs->recordData[(var_r3 * 2) + sp14 + sp18] > 4U) || (sp10 != 0)) {
        sp10 = 1;
        var_r4 = 0;
        var_r7 = var_r3 * 8;
        ...
        do {
            ...
            temp_r2->x = ((s32) *(var_r5 + var_r7) >> 8) + 0xAA + (var_r4 * 8) + var_r4 + (var_r8 * 8);
        ...
        do {
            ...
            *temp_r2_2 = (u8) (&trs->recordData[0xA])[(var_r4_2 * 2) + sp2C + sp14 + sp18];
...
loop_1:
    ...
    temp_r7 = &trs->recordData[temp_r1_2];
    temp_r0 = *temp_r7;
    if ((u32) temp_r0 <= 4U) {
        ...
        temp_r2_2 = &trs->spr34C[(&trs->recordData[1])[temp_r1_2]];
...
void CreateTimeRecordScreen(u8 arg0, TimeRecordScreen *trs) {
    gDispCnt = 0x1040;
    TaskCreate((void (*)()) Task_TimeRecordScreenInit, 0xBDCU, 0x101U, 0U, TaskDestructor_TimeRecordScreen);
    trs->unk3 = arg0;
    sub_80947EC(trs);
    sub_8094924(trs);
    if (trs->unk3 != 0) {
...
s8 sub_8096398(TimeRecordScreen *trs) {
    s32 temp_r0;
    s32 temp_r1;
...
void sub_8096814(TimeRecordScreen *trs) {
    ...
    trs->spr194[0].variant = trs->unk1F + sAnimsTimeAttackDigits.unk2;
    UpdateSpriteAnimation(temp_r4);
    DisplaySprite(temp_r4);
}
