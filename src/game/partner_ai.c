...
#include "game/shared/stage/player_callbacks.h" // Player_HitWithoutRingsUpdate
...
void sub_80B77D0(Struc_3001150 *strc, Player *partner, Player *player); /* static */
...
const Struc_3001150_1C gUnknown_080E310C = {
    .unk1C = -1,
    .unk34 = -1,
};
...
typedef void (*Proc_8E2F410)(Struc_3001150 *strc, Player *partner, Player *player);
extern Proc_8E2F410 gUnknown_08E2F410[2];
extern Struc_3001150 gUnknown_08E2EFA8; // some template
...
void sub_80B75E4(Struc_3001150 *strc, Player *partner, Player *player)
{
    ...
    if (((gStageData.act == ACT_BOSS) || (gStageData.act == ACT_BONUS_ENEMIES) || (gStageData.zone == ZONE_FINAL)
         || ((!sub_80B8D60(unk1C, 14, partner, player)) && (!sub_80B8D60(unk1C, 17, partner, player))
             && (!sub_80B8D60(unk1C, 16, partner, player)) && (!sub_80B8D60(unk1C, 15, partner, player))
             && (!sub_80B8D60(unk1C, 18, partner, player))))
        && (!sub_80B8D60(unk1C, 9, partner, player)) && (!sub_80B8D60(unk1C, 10, partner, player))
        && (!sub_80B8D60(unk1C, 11, partner, player)) && (!sub_80B8D60(unk1C, 12, partner, player))
        && (!sub_80B8D60(unk1C, 13, partner, player)) && (!sub_80B8D60(unk1C, 8, partner, player))
        && (!sub_80B8D60(unk1C, 7, partner, player)) && (!sub_80B8D60(unk1C, 3, partner, player))
...
void sub_80B7878(Struc_3001150 *strc, Player *partner, Player *player)
{
    ...
    var_r1 = (((u32)PseudoRandom32() >> 4) & 0xFF) + 120;
    if (var_r1 > var_r3) {
        var_r1 = var_r3;
    }
...
void sub_80B7914(Struc_3001150 *strc)
{
    DmaCopy32(3, &gUnknown_08E2EFA8, strc, sizeof(*strc));
...
void sub_80B79C8(Struc_3001150 *strc, Player *partner, Player *player)
{
    ...
    if (!(partner->moveState & 0x100)) {
        ...
        if ((ABS(qDX) < 0x2D000) && (ABS(qDY) < 0x1E000)) {
            strc->unk10 = 0;
            return;
        }
        ...
        if (++strc->unk10 >= 240) {
            ...
            if (sub_80B9650(partner, player, &strc->unk164, var_r3, var_r4)) {
                strc->unk10 = 0;
                return;
            }
...
u16 sub_80B7A94(Struc_3001150 *strc) { return InputBufferGetCurrent(&strc->unk1C); }

bool32 sub_80B7AA4(Struc_3001150 *strc) { return strc->unk14; }
...
u32 sub_80B7D74(Struc_3001150_1C *strc, Player *partner, Player *p)
{
    ...
    }
    {
        ...
        if (((partner->charFlags.character == SONIC) && ((temp_r2 == 0) || (temp_r2 == 8)))
            || ((partner->charFlags.character == CREAM) && ((temp_r2 == 0) || (temp_r2 == 8) || (temp_r2 == 0x10)))) {
            var_r1_2 = Q(72);
        } else {
            var_r1_2 = Q(48);
        }
    ...
    if ((strc->unk0 != 0x10) && (partner->moveState & 4)) {
        if ((((0 - ~strc->unk34) | ~strc->unk34) < 0) && ((u32)strc->unk1C <= SQUARE(120))) {
            if ((ABS(strc->unk14) <= Q(32)) && (strc->unk18 > 0xFFF)) {
                ...
                if ((((partner->charFlags.character == SONIC)) || (partner->charFlags.character == KNUCKLES)
                     || (partner->charFlags.character == CREAM) || (partner->charFlags.character == AMY))
                    && (unkC & 0x20000)) {
                    max = Q(32);
                    temp_r0 = PseudoRandom32();
                    var_r1 = 0;
...
u32 sub_80B80C8(Struc_3001150_1C *strc, Player *partner, Player *p)
{
    ...
    if ((strc->unk0 != 0xC) && (partner->moveState & 4)) {
        u32 unkC = partner->unkC;
        if ((partner->charFlags.character == SONIC) && (unkC & 0x10000) && ((u32)strc->unk1C <= SQUARE(120))) {
...
u32 sub_80B8168(Struc_3001150_1C *strc, Player *partner, Player *p)
{
    ...
    if ((strc->unk0 != 0xD) && (partner->moveState & 4)) {
        ...
        if ((partner->charFlags.character == KNUCKLES) && ((temp_r2 == 0x80) || (temp_r2 == 0x100) || (temp_r2 == 0x180))) {
