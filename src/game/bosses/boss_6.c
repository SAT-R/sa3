...
void Task_Boss_8073D98(void) {
    ...
    temp_sl = (u32) (boss->qWorldX << 8) >> 0x10;
    temp_r8 = (u32) (boss->qWorldY << 8) >> 0x10;
    var_r6 = 1;
    sp10 = &boss->unk44;
    if (1 & boss->unk44) {
        var_r6 = 0;
    ...
    if (var_r6 <= 3U) {
        ...
        do {
            ...
            *temp_r3 = var_r1 & 0x3FF;
            temp_r4 = (u16) temp_r7[var_r6];
            sub_8079758(7U, (s16) ((s16) temp_sl + ((s32) (gSineTable[temp_r4 + 0x100] * 5) >> 0xC)), (s16) ((s16) temp_r8 + ((s32) (gSineTable[temp_r4] * 5) >> 0xC)), 0x200, (u16) (s32) temp_r4, 0x14U, 0, boss->vram4C);
            var_r6 = (u32) (u8) (var_r6 + 2);
        } while (var_r6 <= 3U);
    }
    if (!(0x3F & *sp10)) {
        m4aSongNumStart(0x221U);
    ...
    temp_r0 = *sp10 - 1;
    *sp10 = temp_r0;
    if (((temp_r0 << 0x10) == 0) || ((s32) (temp_r8 << 0x10) > 0x01CC0000)) {
        VramFree(boss->spr70.tiles);
        boss->spr70.tiles = NULL;
        m4aSongNumStart(0x221U);
        *sp10 = 0x12C;
        gCurTask->main = (void (*)()) Task_Boss_8073F4C;
        return;
    }
        ...
        if ((u32) temp_r1 <= 0xEFU) {
            if (1 & temp_r1) {
                ...
                sub_8079758(7U, (s16) (((u32) (temp_r0_5 * COS(temp_r4)) >> 14) + 0x5D0),
                                (s16) (((u32) (temp_r0_5 * SIN(temp_r4)) >> 14) + 0x170),
                                ((temp_r0_5 & 3) << 8) | 0x400, (u16) temp_r4, 0x14U, 0, boss->vram4C);
            }
            if (!(0x3F & boss->unk44)) {
                m4aSongNumStart(0x221U);
            }
...
void Task_Ball_807442C(void) {
    ...
    if ((ball->unk1A != 0) && ((s16) temp_r6->unk3E == 0) && (temp_r6->unk3D != 0)) {
        if(HB_COLLISION(I(ball->unk4), I(ball->unk8), sprBall->hitboxes[0].b,
                        I(temp_r6->qWorldX + temp_r6->unkC.x), I(temp_r6->qWorldY + temp_r6->unkC.y),
                        temp_r8->hitboxes[0].b))
        {
...
void sub_807467C(EggPinballBall *ball, Player *inPlayer) {
    ...
    ball->unk1A = 1;
    ball->unk19 += 1;
    temp_r5 = (u16) sa2__sub_8004418((s16) ((s32) ((inPlayer->qWorldY - ball->unk8) << 8) >> 0x10), (s16) ((s32) ((inPlayer->qWorldX - ball->unk4) << 8) >> 0x10));
