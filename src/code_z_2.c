...
void sub_80C6318(void)
{
    ...
    switch (gUnknown_03006C20) {
        case 0:
            temp_r6 = REG_SIOMULTI0;
            temp_r1 = gUnknown_3000428.unk0;
            temp_r0 = (u32)(temp_r6 << (temp_r1 * 0x10)) >> 0x10;
            temp_r6_2 = (u32)(temp_r6 << ((1 - temp_r1) * 0x10)) >> 0x10;
            temp_r5 = gUnknown_3000428.unkA;
            if (temp_r5 == 0) {
                temp_r2 = gUnknown_3000428.unk6;
                if (temp_r0 == temp_r2) {
                    temp_r3 = gUnknown_3000428.unk2;
                    if (temp_r3 < 4) {
                        if ((temp_r0 == (u16)~gUnknown_3000428.unk4) && (temp_r6_2 == (u16)~temp_r2)) {
                            gUnknown_3000428.unk2 = (u16)(temp_r3 + 1);
                        }
                    } else {
                        gUnknown_3000428.unkA = (u16)temp_r6_2;
                        if (temp_r6_2 == 0x8002) {
                            gUnknown_03006C20 = 1;
                            temp_r0_2 = sub_80C65F0(1U);
                            gUnknown_3000434 = temp_r0_2;
                            REG_SIODATA32 = temp_r0_2;
                            gUnknown_3000428.unk2 = temp_r5;
                            goto block_def;
                        } else {
                            gUnknown_3000428.unkA = temp_r5;
                        }
                    }
                }
            ...
            block_13:
                temp_r0_3 = gUnknown_3000428.unk2;
                if ((u32)temp_r0_3 < 4) {
                    var_r0 = gUnknown_082B533C[temp_r0_3];
                } else {
                    var_r0 = 0x8000;
                }
                gUnknown_3000428.unk4 = var_r0;
                gUnknown_3000428.unk6 = (u16)~temp_r6_2;
                temp_r1_2 = gUnknown_3000428.unk0;
                REG_SIODATA32 = ((gUnknown_3000428.unk4 << ((1 - temp_r1_2) * 0x10)) + (gUnknown_3000428.unk6 << (temp_r1_2 * 0x10)));
            }
        ...
        case 1:
            if (sub_80C6548(gUnknown_03006C20) != 0) {
                ...
                CpuFill32(0, &gUnknown_3000428, 6);
                gUnknown_03006C20 = 0;
            } else {
                gUnknown_03006C20 = 2;
            }
        block_28:
            REG_SIOMULTI0 = gUnknown_3000434 = sub_80C65F0(gUnknown_03006C20);
            REG_SIOCNT |= 0x80;
            REG_TM3CNT_H = 0xC1;
            break;
        case 2:
...
s32 sub_80C6548(u8 arg0)
{
    ...
    if (!sub_80C65B4()) {
        switch (temp_r4) {
            case 1:
                gUnknown_300043C = ((gUnknown_3000438 * 0x10) >> 8) & temp_r4;
                if (temp_r5 == 1) {
                    break;
                } else {
                block_8:
...
bool8 sub_80C65B4(void)
{
    ...
    do {
        temp_r0_2 = var_r0 - 1;
        var_r3 ^= (temp_r4 >> (temp_r0_2 * 4)) & 0xF;
        var_r0 = temp_r0_2;
    } while (var_r0 != 0);

    if (var_r3 == (0xF & temp_r0)) {
        return 0;
    }
    return 1;
}
...
s32 sub_80C65F0(u8 arg0)
{
    ...
    switch (arg0) {
        case 1:
            ...
            break;
        case 2:
            var_r4 = ((gUnknown_300043C & 0xFFFFFF) * 0x10) | 0x20000000;
            var_r3 = (u8)(var_r4 >> 28);
            ...
            break;
        case 3:
            var_r4 = (gUnknown_0300620C * 0x10) | 0x40000000;
            var_r3 = (u8)(var_r4 >> 28);
            var_r2 = 6;
            do {
                var_r3 ^= (var_r4 >> (var_r2 * 4)) & 0xF;
