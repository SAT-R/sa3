...
const Tilemap *const gTilemaps[] = {
    ...
    [TM_CHARSELECT_NAME_SONIC   ] = (Tilemap * const)&unknown_365,
    [TM_CHARSELECT_NAME_CREAM   ] = (Tilemap * const)&unknown_366,
    [TM_CHARSELECT_NAME_TAILS   ] = (Tilemap * const)&unknown_367,
    [TM_CHARSELECT_NAME_KNUCKLES] = (Tilemap * const)&unknown_368,
    [TM_CHARSELECT_NAME_AMY     ] = (Tilemap * const)&unknown_369,
    [TM_UNKNOWN_370] = (Tilemap * const)&unknown_370,
    [TM_UNKNOWN_371] = (Tilemap * const)&unknown_371,
    [TM_CHARSELECT_NAME_QUESTION_MARKS] = (Tilemap * const)&unknown_372,
    [TM_MULTI_VS_BACKDROP       ] = (Tilemap * const)&unknown_373,
    ...
    [TM_MULTI_CONNECTION_PENDING          ] = (Tilemap * const)&unknown_393,
    [TM_MULTI_CONNECTION_ERROR            ] = (Tilemap * const)&unknown_394,
    [TM_MULTI_CONNECTION_SUCCESS          ] = (Tilemap * const)&unknown_395,
    [TM_MULTI_SINGLE_PAK_TRANSFER_MASTER  ] = (Tilemap * const)&unknown_396,
    ...
    [TM_CHAO_MAP_LIST] = (Tilemap * const)&unknown_453,
    [TM_CHAO_MAP_BG] = (Tilemap * const)&unknown_454,
