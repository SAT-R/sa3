...
const Tilemap unknown_360 = {
    ...
    .animFrameCount = 0,
    .animDelay = 0,
    .tiles = Tiles_unknown_360,
    .tilesSize = sizeof(Tiles_unknown_360) - (0 * 0x00),
    .palette = Palette_unknown_360,
    .palOffset = 0,
    .palLength = sizeof(Palette_unknown_360) / sizeof(u16),
    .map = Tilemap_unknown_360,
};
