...
const Tilemap unknown_318 = {
    .xTiles = 45,
    .yTiles = 20,
    .animTileSize = 0x00,
    .animFrameCount = 0,
    .animDelay = 0,
    .tiles = Tiles_unknown_318,
    .tilesSize = sizeof(Tiles_unknown_318) - (0 * 0x00),
    .palette = Palette_unknown_318,
    .palOffset = 0,
    .palLength = sizeof(Palette_unknown_318) / sizeof(u16),
    .map = Tilemap_unknown_318,
};
